...
namespace BuzzFeeder.Implementation.Series
{
    public class TvinciSeriesLikesBuzzImpl : BaseSeriesBuzzImpl
    {
        ...
        public TvinciSeriesLikesBuzzImpl(int nGroupID, DateTime dtPeriod, TimeSpan tsInterval, int Weight, List<string> lActions, List<string> lAssetTypes, List<int> lFormulaWeights)
