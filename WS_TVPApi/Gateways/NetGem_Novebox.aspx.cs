...
//                List<Media> mediaList = m_MediaService.GetMediasInfo(GetInitObj(), new List<int> {int.Parse(sMediaID)}, "345X480", true);
//                Media media = mediaList != null && mediaList.Count > 0 ? mediaList[0] : null;
...
//                {
//                    long mediaCount = 0;
//                    List<Media> lstMedias = m_MediaService.GetChannelMultiFilter(GetInitObj(), int.Parse(tvmChid), "full", 50, 0, OrderBy.None, eOrderDirection.Asc, null, Tvinci.Data.Loaders.TvinciPlatform.Catalog.CutWith.OR);
