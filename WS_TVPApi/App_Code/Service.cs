...
//    //public Media GetMediaInfo(InitializationObject initObj, string ws_User, string ws_Pass, int MediaID, int mediaType, string picSize, bool withDynamic)
//    //{
//    //    initObj.ApiUser = ws_User;
//    //    initObj.ApiPass = ws_Pass;
//    //    return m_mediaService.GetMediasInfo(initObj, new List<int>() {MediaID}, picSize, withDynamic);
//    //}

//    //Get Channel media
//    //[WebMethod(EnableSession = true, Description = "Deprecated! Use 'ws/Media/Service.asmx' instead.")]
//    //public List<Media> GetChannelMediaList(InitializationObject initObj, string ws_User, string ws_Pass, int ChannelID, string picSize, int pageSize, int pageIndex)
//    //{
//    //    initObj.ApiUser = ws_User;
//    //    initObj.ApiPass = ws_Pass;
...
//    //Get Channel media
//    //[WebMethod(EnableSession = true, Description = "Deprecated! Use 'ws/Media/Service.asmx' instead.")]
//    //public List<Media> GetChannelMediaListWithMediaCount(InitializationObject initObj, string ws_User, string ws_Pass, int ChannelID, string picSize, int pageSize, int pageIndex, ref long mediaCount)
//    //{
//    //    initObj.ApiUser = ws_User;
//    //    initObj.ApiPass = ws_Pass;
...
//        initObj.ApiUser = ws_User;
//        initObj.ApiPass = ws_Pass;
//        return m_mediaService.GetPeopleWhoWatched(initObj, mediaID, picSize, pageSize, pageIndex);
//    }
...
//        initObj.ApiUser = ws_User;
//        initObj.ApiPass = ws_Pass;
//        return m_mediaService.GetUserItems(initObj, itemType, picSize, pageSize, start_index);
//    }
