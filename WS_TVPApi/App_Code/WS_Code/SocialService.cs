...
namespace TVPApiServices
{
    ...
    public class SocialService : System.Web.Services.WebService, ISocialService
    {
      ...
      SiteHelper.GetClientIP());
        ...
        public UserSocialActionObject[] GetUserActions(InitializationObject initObj, string[] userActions, int mediaId, int startIndex, int numOfRecords, SocialPlatform socialPlatform)
        {
        ...
        public UserSocialActionObject[] GetFriendsActions(InitializationObject initObj, string[] userActions, int mediaId, int startIndex, int numOfRecords, SocialPlatform socialPlatform)
        {
