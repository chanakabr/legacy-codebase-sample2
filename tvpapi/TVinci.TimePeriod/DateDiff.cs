	...
	public sealed class DateDiff
	{
		...
		public int ElapsedHours
		{
			get
			{
				...
				{
					DateTime compareDate = date1.AddYears( ElapsedYears ).
						AddMonths( ElapsedMonths ).AddDays( ElapsedDays );
		...
		public int ElapsedMinutes
		{
			get
			{
				...
				{
					DateTime compareDate = date1.AddYears( ElapsedYears ).
						AddMonths( ElapsedMonths ).AddDays( ElapsedDays ).AddHours( ElapsedHours );
		...
		public int ElapsedSeconds
		{
			get
			{
				if ( !elapsedSeconds.HasValue )
				{
					DateTime compareDate = date1.AddYears( ElapsedYears ).
						AddMonths( ElapsedMonths ).AddDays( ElapsedDays ).
						AddHours( ElapsedHours ).AddMinutes( ElapsedMinutes );
