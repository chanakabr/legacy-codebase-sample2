...
//                List<BaseObject> 
//                TVPApiModule.Objects.Responses.UnifiedSearchResponse ret = m_oCatalogExternalSearchLoader.Execute() as TVPApiModule.Objects.Responses.UnifiedSearchResponse;
//                this.TotalResults = ret.TotalItems;
//                this.RequestId = m_oCatalogExternalSearchLoader.RequestId;
//                this.Status = new Status() { Code = m_oCatalogExternalSearchLoader.Status.Code, Message = m_oCatalogExternalSearchLoader.Status.Message };
