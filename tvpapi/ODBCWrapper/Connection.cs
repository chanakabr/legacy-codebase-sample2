    ...
    public class Connection
    {
        ...
        public SqlConnection GetConnection()
        {
            if (this.m_conn == null)
            {
                ...
                if (string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["UseSQL2008"]) || 
                    !bool.Parse(System.Configuration.ConfigurationManager.AppSettings["UseSQL2008"]))
                {
