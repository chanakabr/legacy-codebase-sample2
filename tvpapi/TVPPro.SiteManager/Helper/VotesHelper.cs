...
namespace TVPPro.SiteManager.Helper
{
    public static class VotesHelper
    {
                ...
                if (!string.IsNullOrEmpty(siteGuid))
                {
                    ...
                    switch (voteStatus)
                    {
                        case VoteResponse.VOTE_NOT_REGISTERED:
                            ...
                            query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("SCORE", GetVotingRatio(siteGuid));
                            query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("STATUS", "1");
                            query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("VOTE_DATE", DateTime.UtcNow);
        ...
        public static VoteResponse IaAlreadyVoted(string mediaId, string siteGuid)
        {
            ...
            TVPApi.ODBCWrapper.DataSetSelectQuery selectQuery = new TVPApi.ODBCWrapper.DataSetSelectQuery();
            ...
            selectQuery += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("SITE_GUID", "=", siteGuid);
            selectQuery += " and ";
            selectQuery += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("STATUS", "=", 1);
        ...
        public static Dictionary<string, RatedMediaEntity> GetMediasByRating()
        {
            ...
            DataSetSelectQuery selectQuery = new TVPApi.ODBCWrapper.DataSetSelectQuery();
        ...
        public static bool StartNewVoteCycle(DateTime when)
        {
            ...
            query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("CreateDate", DateTime.UtcNow);
            query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("ResetDate", when);
            if (!query.Execute())
            {
        ...
        {
            TVPApi.ODBCWrapper.DataSetSelectQuery delete = new TVPApi.ODBCWrapper.DataSetSelectQuery();
