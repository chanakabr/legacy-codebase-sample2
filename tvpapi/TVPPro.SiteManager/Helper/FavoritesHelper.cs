...
namespace TVPPro.SiteManager.Helper
{
    public static class FavoritesHelper
    {
        ...
        public static bool RemoveAllUserFavorites(string UserId)
        {
            ...
            return UsersService.Instance.RemoveUserFavoriteItems(medias.Select(x=> long.Parse(x.m_sItemCode)).ToArray());
        }
        ...
        public static bool RemoveFromFavorites(string ItemId, int ItemType, string UserId)
        {
            ...
            //    query += TVPApi.ODBCWrapper.Parameter.NEW_PARAM("Status", "=", "0");
        ...
        {
            var oFavorites = UsersService.Instance.GetUserFavorite(ItemType != 0 ? ItemType.ToString() : string.Empty,
        ...
        public static bool ItemExistOnFavorite(string mediaID, string UserId)
        {
            ...
            bool retVal = false;
            var favoriteObj = UsersService.Instance.GetUserFavorite(UsersService.Instance.GetUserID(), UsersService.Instance.GetDomainID(), string.Empty);
            if (favoriteObj != null)
            {
