...
namespace TVPPro.SiteManager.Helper
{
    public class SiteHelper
    {
        ...
        public static string GetSiteBaseURL(bool isSecure)
        {
            ...
            {
                return string.Concat((isSecure) ? "https://" : "http://", HttpContext.Current.Request.GetUrl().Host, HttpContext.Current.Request.GetApplicationPath().TrimEnd('/'), '/');
            }
        }
        ...
        //{
        //    string Identifier = System.Configuration.ConfigurationManager.AppSettings["ClientIdentifier"];
        ...
        public static void CheckAge()
        {
            ...
            {
                // TODO: initially it was RawURL. is this ok?
                TVPPro.SiteManager.Helper.SessionHelper.NextPage = HttpContext.Current.Request.GetUrl().ToString();
        ...
        {
            return HttpContextUtils.IsVirtualDirectory();
        }
        ...
        public static bool TryLoadXML(string FileURL, out XmlDocument XMLDoc)
        {
            ...
            try
            {
                XMLDoc.Load(HttpContext.Current.ServerMapPath(FileURL));
