...
namespace TVPPro.SiteManager.Services
{
    public class PricingService
    {
        ...
        private PricingService()
        {
            ...
            groupId = Core.Pricing.Utils.GetGroupID(wsUserName, wsPassword);
        ...
        public PrePaidModule GetPrePaidModuleData(int ppCode)
        {
            ...
            try
            {
                ppModule = Core.Pricing.Module.GetPrePaidModuleData(groupId, ppCode, string.Empty, string.Empty, string.Empty);
        ...
        public Subscription[] GetSubscriptionsContainingMediaFile(int iMediaID, int iMediaFileID)
        {
            ...
            try
            {
                subscriptions = Core.Pricing.Module.GetSubscriptionsContainingMediaFile(groupId, iMediaID, iMediaFileID);
        ...
        public int[] GetSubscriptionIDsContainingMediaFiles(int iMediaID, int iMediaFileID)
        {
            ...
            try
            {
                IdsResponse response = Core.Pricing.Module.GetSubscriptionIDsContainingMediaFile(groupId, iMediaID, iMediaFileID);
                if (response != null && response.Ids != null)
                {
                    subscriptionIDs = response.Ids.ToArray();
                }
        ...
        public string GetSubscriptionsContainingMediaSTR(int iMediaID, int iMediaFileID)
        {
            ...
            try
            {
                sRet = Core.Pricing.Module.GetSubscriptionsContainingMediaSTR(groupId, iMediaID, iMediaFileID);
            }
            catch (Exception ex)
            {
        ...
        public int[] GetSubscriptionMediaList(string subscriptionID, int fileType, string device)
        {
            ...
            try
            {
                res = Core.Pricing.Module.GetSubscriptionMediaList(groupId, subscriptionID, fileType, device);
        ...
        public MediaFilePPVModule[] GetPPVModuleListForMediaFile(int[] mediaFiles, string country, string languageCode, string device)
        {
            ...
            try
            {
                res = Core.Pricing.Module.GetPPVModuleListForMediaFiles(groupId, mediaFiles, country, languageCode, device);
        ...
        public Subscription[] GetSubscriptionsForSingleItem(int MediaId, int FileTypeId)
        {
            ...
            try
            {
                res = Core.Pricing.Module.GetSubscriptionsContainingMedia(groupId, MediaId, FileTypeId);
        ...
        public Subscription[] GetIndexedSubscriptionsForSingleItem(int MediaId, int FileTypeId, int iCount)
        {
            ...
            try
            {
                res = Core.Pricing.Module.GetIndexedSubscriptionsContainingMedia(groupId, MediaId, FileTypeId, iCount);
        ...
        public void SetCouponUsed(string sCouponCode)
        {
            try
            {
                CouponsStatus status = Core.Pricing.Module.SetCouponUsed(groupId, sCouponCode, UsersService.Instance.GetUserID(), 0);
            }
            catch (Exception ex)
            {
        ...
        public CouponData GetCouponStatus(string sCouponCode)
        {
            try
            {
                var res = Core.Pricing.Module.GetCouponStatus(groupId, sCouponCode, 0); 
            }
            catch (Exception ex)
            {
        ...
        public Campaign[] GetMediaCampaigns(int mediaID)
        {
            try
            {
                return Core.Pricing.Module.GetMediaCampaigns(groupId, mediaID, string.Empty, string.Empty, string.Empty, false);
            }
            catch (Exception ex)
            {
        ...
        public Campaign[] GetCampaignsByType(CampaignTrigger trigger, bool isAlsoInactive)
        {
            try
            {
                return Core.Pricing.Module.GetCampaignsByType(groupId, trigger, string.Empty, string.Empty, string.Empty, isAlsoInactive);
            }
            catch (Exception ex)
            {
        ...
        public PPVModule GetPPVModuleData(string PPVCode)
        {
            try
            {
                return Core.Pricing.Module.GetPPVModuleData(groupId, PPVCode, string.Empty, string.Empty, string.Empty);
            }
            catch (Exception ex)
            {
                logger.ErrorFormat("Error calling webservice protocol : GetMediaCampaigns, Error Message: {0}, Parameters :  SiteGUID : {1}", ex.Message, UsersService.Instance.GetUserID());
