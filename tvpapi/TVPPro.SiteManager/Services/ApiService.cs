...
namespace TVPPro.SiteManager.Services
{
    public class ApiService
    {
        ...
        private ApiService()
        {
            ...
            groupId = APILogic.Utils.GetGroupID(wsUserName, wsPassword);
        ...
        private void InitAvailableFileTypes()
        {
            ...
            if (m_TVMGroupId > 0)
            {
                ...
                try
                {
                    ...
                    FileTypes = Core.Api.Module.GetAvailableFileTypes(groupId);
        ...
        public Locale GetAdminLocaleValues(string token, string ip)
        {
            ...
            try
            {
                ...
                if (Core.Api.Module.GetAdminTokenValues(groupId, ip, token, ref countryName, ref language, ref deviceName, ref userStatus))
                {
                    retVal = new Locale();
        ...
        public MeidaMaper[] GetMediaIDsFromFileIDs(int[] fileIDs)
        {
            ...
            try
            {
                ...
                mediaMapper = Core.Api.Module.MapMediaFiles(groupId, fileIDs);
        ...
        public RateMediaObject RateMedia(int mediaId, int rating)
        {
            ...
            try
            {
                ...
                res = Core.Api.Module.RateMedia(groupId, mediaId, siteGuid, rating);
            }
            catch (Exception ex)
            {
        ...
        public bool CleanUserHistory(int[] mediaIDs)
        {
            ...
            try
            {
                ...
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                var status = Core.Api.Module.CleanUserHistory(groupId, siteGuid, mediaIDs == null ? null : mediaIDs.ToList());
        ...
        public MediaMarkObject GetMediaMark(int iMediaID)
        {
            ...
            try
            {
                ...
                mediaMark = Core.Api.Module.GetMediaMark(groupId, iMediaID, UsersService.Instance.GetUserID());
            }
            catch (Exception ex)
            {
        ...
        public MediaMarkObject GetMediaMarkForUser(int iMediaID, string sUserGuid)
        {
            ...
            try
            {
                ...
                mediaMark = Core.Api.Module.GetMediaMark(groupId, iMediaID, sUserGuid);
            }
            catch (Exception ex)
            {
                logger.ErrorFormat("Error calling webservice protocol : GetMediaMark, Error Message: {0}, Parameters :  Media ID: {1}, User id: {2}", ex.Message, iMediaID, UsersService.Instance.GetUserID());
        ...
        public bool AddUserSocialAction(int iMediaID, SocialAction action, SocialPlatform platform)
        {
            ...
            try
            {
                ...
                bRet = Core.Api.Module.AddUserSocialAction(groupId, iMediaID, UsersService.Instance.GetUserID(), action, platform);
            }
            catch (Exception ex)
            {
        ...
        public string CheckGeoBlockMedia(int iMediaID, string UserIP)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                geo = Core.Api.Module.CheckGeoBlockMedia(groupId, iMediaID, UserIP);
            }
            catch (Exception ex)
            {
        ...
        public EPGChannelObject[] GetEPGChannel(string PicSize)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                var temp = Core.Api.Module.GetEPGChannel(groupId, PicSize);
        ...
        //        wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
        //        wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
        //        res = Core.Api.Module.GetEPGChannelProgramme(groupId, EpgId, PicSize, unit, nFromOffsetDay, nToOffsetDay, nUTCOffset);
        //        if (res.Length > 0)
        //            DataHelper.SetCacheObject(sKey, res);
        //    }
        //    catch (Exception ex)
        ...
        //        wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
        //        wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
        //        res = Core.Api.Module.GetEPGMultiChannelProgramme(groupId, channelID, PicSize, unit, nFromOffsetDay, nToOffsetDay, nUTCOffset);
        //        if (res.Length > 0)
        //            DataHelper.SetCacheObject(sKey, res);
        //    }
        //    catch (Exception ex)
        ...
        public GroupRule[] GetGroupMediaRules(int MediaId, int siteGuid, string deviceUDID)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                var temp = Core.Api.Module.GetGroupMediaRules(groupId, MediaId, siteGuid, SiteHelper.GetClientIP(), deviceUDID);
                res = temp == null ? null : temp.ToArray();
            }
            catch (Exception ex)
            {
        ...
        public GroupRule[] GetUserGroupRules()
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                var temp = Core.Api.Module.GetUserGroupRules(groupId, UsersService.Instance.GetUserID());
                res = temp == null ? null : temp.ToArray();
            }
            catch (Exception ex)
            {
        ...
        public bool SetUserGroupRule(int ruleID, string pinCode, int isActive)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                res = Core.Api.Module.SetUserGroupRule(groupId, UsersService.Instance.GetUserID(), ruleID, pinCode, isActive);
        ...
        public bool CheckParentalPIN(int ruleID, string parentalPIN, string siteGuid)
        {
            ...
            try
            {
                ...
                retVal = Core.Api.Module.CheckParentalPIN(groupId, siteGuid, ruleID, parentalPIN);
            }
            catch (Exception ex)
            {
        ...
        public DeviceAvailabiltyRule GetAvailableDevices(int MediaId)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                res = Core.Api.Module.GetAvailableDevices(groupId, MediaId);
            }
            catch (Exception ex)
            {
        ...
        public bool SetRuleState(int domainID, int ruleID, int isActive)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                //res = Core.Api.Module.SetRuleState(groupId, domainID, UsersService.Instance.GetUserID(), ruleID, isActive);
        ...
        public string[] GetAutoCompleteList(string sPrefix)
        {
            ...
            try
            {
                ...
                req.m_InfoStruct.m_Metas = MediaConfiguration.Instance.Data.TVM.SearchValues.Metadata.ToString().Split(new Char[] { ';' }).ToList();
                req.m_InfoStruct.m_Tags = MediaConfiguration.Instance.Data.TVM.SearchValues.Tags.ToString().Split(new Char[] { ';' }).ToList();
                ...
                var temp = Core.Api.Module.GetAutoCompleteList(groupId, req);
                ret = temp == null ? null : temp.ToArray();
            }
            catch (Exception ex)
            {
        ...
        public bool SendToFriend(string userName, string userEmail, string friendName, string friendEmail, int mediaId)
        {
            ...
            try
            {
                wsUserName = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultUser;
                wsPassword = PlatformServicesConfiguration.Instance.Data.ApiService.DefaultPassword;
                res = Core.Api.Module.SendToFriend(groupId, userName, userEmail, friendEmail, friendName, mediaId);
