...
namespace TVPPro.SiteManager.DataLoaders
{
    ...
    public class UserSocialMediasLoader : TVMAdapter<dsItemInfo>
    {
        ...
        public SocialAction SocialAction
        {
            get
            {
                return Parameters.GetParameter<SocialAction>(eParameterType.Retrieve, "SocialAction", SocialAction.UNKNOWN);
            }
            set
            {
                Parameters.SetParameter<SocialAction>(eParameterType.Retrieve, "SocialAction", value);
            }
        }
        ...
        public SocialPlatform SocialPlatform
        {
            get
            {
                return Parameters.GetParameter<SocialPlatform>(eParameterType.Retrieve, "SocialPlatform", SocialPlatform.UNKNOWN);
            }
            set
            {
                Parameters.SetParameter<SocialPlatform>(eParameterType.Retrieve, "SocialPlatform", value);
            }
        }
