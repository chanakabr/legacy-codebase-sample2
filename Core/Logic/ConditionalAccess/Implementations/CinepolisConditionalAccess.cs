...
namespace Core.ConditionalAccess
{
    public class CinepolisConditionalAccess : TvinciConditionalAccess
    {
        ...
        {
            BillingResponse res = Billing.Module.CC_DummyChargeUser(m_nGroupID, sSiteGuid, dPrice, sCurrency, sUserIP, sCustomData, nPaymentNumber, nRecPeriods, sExtraParams);
        ...
        protected override bool HandleChargeUserForSubscriptionBillingSuccess(string sSiteGUID, int domainID, Subscription theSub, 
            ...
            ref long lBillingTransactionID, ref long lPurchaseID, bool isDummy, string billingGuid = null, DateTime? startDate = null, DateTime? endDate = null)
        {
            bool res = base.HandleChargeUserForMediaFileBillingSuccess(sSiteGUID, domainID, relevantSub, dPrice, sCurrency,
                ...
                ref lBillingTransactionID, ref lPurchaseID, isDummy, billingGuid);
