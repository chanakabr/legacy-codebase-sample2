...
namespace ApiLogic.IndexManager.QueryBuilders
{
    public class ESMediaQueryBuilder
    {
        ...
        private MultiMatchQuery GetMultiMatchQuery()
        {
            ...
            {
                multiMatchQuery.Fields.Add(ElasticSearch.Common.Utils.GetKeyNameWithPrefix(searchValue.m_sKey, searchValue.m_sKeyPrefix));
            }
        ...
        public string BuildMediaAutoCompleteQuery()
        {
            ...
            foreach (SearchValue searchValue in oSearchObject.m_dOr)
            {
                multiMatchQuery.Fields.Add(ElasticSearch.Common.Utils.GetKeyNameWithPrefix(searchValue.m_sKey.ToLower(), searchValue.m_sKeyPrefix.ToLower()));
            }
