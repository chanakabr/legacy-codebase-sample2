...
namespace ApiLogic.Pricing.Handlers
{
    public class SubscriptionManager
    {
        ...
        private static readonly Lazy<SubscriptionManager> lazy = new Lazy<SubscriptionManager>(() =>
                                    new SubscriptionManager(PricingCache.Instance, PricingDAL.Instance), LazyThreadSafetyMode.PublicationOnly);
        ...
        public SubscriptionManager(IPricingCache pricingCache, ISubscriptionManagerRepository repository)
        {
        ...
        public GenericResponse<Subscription> Add(ContextData contextData, Subscription subscriptionToInsert)
        {
