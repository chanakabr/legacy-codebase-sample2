...
namespace Core.ConditionalAccess
{
    public class Module
    {
            ...
            long entitlementId = 0, string externalId = "", eTransactionType? businessModuleType = null, eTransactionType? transactionType = null)
        {
            ...
            if (t != null)
            {
                return t.GetDomainTransactionsHistory(domainID, dStartDate, dEndDate, pageSize, pageIndex, orderBy, entitlementId, externalId, businessModuleType, transactionType);
            }
            else
            {
                return null;
        ...
        public static PlaybackContextResponse GetPlaybackContext(int groupID, string userId, string udid, string ip, string assetId, eAssetTypes assetType,
            ...
            string sourceType = null, bool isPlaybackManifest = false, Dictionary<string, string> adapterData = null)
        {
