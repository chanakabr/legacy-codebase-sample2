...
namespace APILogic
{
    public class ExportLogic
    {
        ...
        private static void SaveExportToS3(int groupId, long taskId, string basePath, string fileName)
        {
            ...
            if (catalogConfig.HasObject() && catalogConfig.Object.UploadExportDatalake.HasValue && catalogConfig.Object.UploadExportDatalake.Value && GroupSettingsManager.Instance.IsOpc(groupId))
            {
