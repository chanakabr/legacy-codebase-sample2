namespace Phoenix.Generated.Api.Events.Crud.Asset.LiveToVodAsset
{
    ...
    /// <summary>
    /// An event used to reflect a crud operation in a live to vod asset
    ///
    ...
    public partial class LiveToVodAsset
    {
        ...
        [JsonProperty("mediaFileUrls", NullValueHandling = NullValueHandling.Ignore)]
        public string[] MediaFileUrls { get; set; }

        [JsonProperty("origEndDate")]
        public long OrigEndDate { get; set; }

        [JsonProperty("origProgramAssetId")]
        public long OrigProgramAssetId { get; set; }

        [JsonProperty("origStartDate")]
        public long OrigStartDate { get; set; }
