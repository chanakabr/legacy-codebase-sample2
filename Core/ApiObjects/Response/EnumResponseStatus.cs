namespace ApiObjects.Response
{
    public enum eResponseStatus
    {
        ...
        ScheduledSubscriptionNotFound = 3067,
        ...
        ExceedingAllowedImmediateRecordingAttempts = 3095,
        ...
        MetaSystemNameAlreadyInUse = 4032,
        MetaDoesNotExist = 4033,
        CanNotChangePredefinedMetaSystemName = 4034,
        CanNotDeletePredefinedMeta = 4035,
        InvalidMutlipleValueForMetaType = 4036,
        AssetStructMissingBasicMetaIds = 4037,
        AssetExternalIdMustBeUnique = 4038,
        AssetDoesNotExist = 4039,
        InvalidMetaType = 4040,
        InvalidValueSentForMeta = 4041,
        DeviceRuleDoesNotExistForGroup = 4042,
        GeoBlockRuleDoesNotExistForGroup = 4043,
        TagAlreadyInUse = 4044,
        ...
        InvalidNotificationSettingsSetup = 8046,
