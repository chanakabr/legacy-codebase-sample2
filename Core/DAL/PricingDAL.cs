...
namespace DAL
{
    ...
    {
        DataTable Get_PPVModuleData(int groupId, int? ppvModuleId);
        DataTable Get_PPVDescription(int ppvModuleId);

        DataTable Get_PPVFileTypes(int groupId, int ppvModuleId);

        int DeletePPV(int groupID, long id);

        int InsertPPV(int groupID, IngestPPV ppv, int priceCodeID, int usageModuleID, int discountID, int couponGroupID, List<long> fileTypes);
    }
    ...
    public interface ISubscriptionManagerRepository
    {
        ...
        int InsertMPP(int groupID, IngestMultiPricePlan mpp, List<KeyValuePair<long, int>> pricePlansCodes, List<long> channels, List<long> fileTypes,
    ...
    public class PricingDAL : ICampaignRepository, IPriceDetailsRepository, IPricePlanRepository, IModuleManagerRepository, IDiscountDetailsRepository, IPreviewModuleRepository, ICollectionRepository, IPartnerRepository, IPPVManagerRepository, ISubscriptionManagerRepository
    {
        ...
        public DataTable Get_PPVModuleData(int nGroupID, int? nPPVModuleID)
        {
        ...
        public DataTable Get_PPVDescription(int nPPVModuleID)
        {
        ...
        public DataTable Get_PPVFileTypes(int nGroupID, int nPPVModuleID)
        {
        ...
        public int InsertMPP(int groupID, IngestMultiPricePlan mpp, List<KeyValuePair<long, int>> pricePlansCodes, List<long> channels, List<long> fileTypes,
            int previewModuleID, int internalDiscountID, XmlDocument couponsGroups, XmlDocument productCodes)
        {
            try
            {
        ...
        public int InsertPPV(int groupID, IngestPPV ppv, int priceCodeID, int usageModuleID, int discountID, int couponGroupID, List<long> fileTypes)
        {
        ...
        public int DeletePPV(int groupId, long id)
        {
