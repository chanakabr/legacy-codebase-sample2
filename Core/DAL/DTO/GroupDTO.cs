...
namespace DAL.DTO
{
    ...
    public class GroupDTO
    {
        ...
        public CredentialsDTO ApiCredentials { get; set; }

        [JsonProperty(PropertyName = "billing_credentials")]
        public CredentialsDTO BillingCredentials { get; set; }

        [JsonProperty(PropertyName = "conditinal_access_credentials")]
        public CredentialsDTO ConditionalAccessCredentials { get; set; }

        [JsonProperty(PropertyName = "domains_credentials")]
        public CredentialsDTO DomainsCredentials { get; set; }

        [JsonProperty(PropertyName = "notifications_credentials")]
        public CredentialsDTO NotificationsCredentials { get; set; }

        [JsonProperty(PropertyName = "pricing_credentials")]
        public CredentialsDTO PricingCredentials { get; set; }

        [JsonProperty(PropertyName = "social_credentials")]
        public CredentialsDTO SocialCredentials { get; set; }

        [JsonProperty(PropertyName = "users_credentials")]
        public CredentialsDTO UsersCredentials { get; set; }
