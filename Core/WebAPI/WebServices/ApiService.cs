...
{
    public class ApiService : System.Web.Services.WebService, IApiService
    {
        ...
        public UserIMRequestObject TVAPI_GetTvinciGUID(string sWSUserName, string sWSPassword, InitializationObject oInitObj)
        {
            try
            {
                Int32 nGroupID = APILogic.Utils.GetGroupID(sWSUserName, sWSPassword);
        ...
        {
            int nGroupID = APILogic.Utils.GetGroupID(sWSUserName, sWSPassword);
            if (nGroupID != 0)
            {
        ...
        {
            int nGroupID = APILogic.Utils.GetGroupID(username, password);
        ...
        public Scheduling GetProgramSchedule(string sWSUserName, string sWSPass, int nProgramId)
        {
            ...
            {
                Int32 nGroupID = APILogic.Utils.GetGroupID(sWSUserName, sWSPass);
                if (nGroupID != 0)
                {
        ...
        {
            Int32 groupID = APILogic.Utils.GetGroupID(sWSUserName, sWSPassword);
            if (groupID != 0)
            {
        ...
        public ParentalRulesResponse GetParentalRules(string userName, string password)
        {
            ...
            int groupId = APILogic.Utils.GetGroupID(userName, password);
        ...
        public Status SetUserParentalRules(string userName, string webServicePassword, string siteGuid, long ruleId, int isActive, int domainId)
        {
            ...
            int groupId = APILogic.Utils.GetGroupID(userName, webServicePassword);
        ...
        public RecommendationEngineResponse UpdateRecommendationEngineConfiguration(string userName, string password, int recommendationEngineId)
        {
            ...
            Int32 groupID = APILogic.Utils.GetGroupID(userName, password);
