...
namespace WebAPI.Managers
{
    public static class MimeType
    {
        ...
        //https://stackoverflow.com/questions/58510/using-net-how-can-you-find-the-mime-type-of-a-file-based-on-the-file-signature?rq=1
        ...
        public static string GetMimeByExtention(string extension)
        {
            if (extension == null)
