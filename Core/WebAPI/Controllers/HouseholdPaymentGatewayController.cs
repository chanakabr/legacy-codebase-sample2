    ...
    public class HouseholdPaymentGatewayController : IKalturaController
    {
        ...
        static public bool SetChargeID(string paymentGatewayExternalId, string chargeId)
        {
            ...
            try
            {
                ...
                // call client
                response = ClientsManager.BillingClient().SetHouseholdChargeID(groupId, paymentGatewayExternalId, domainId, chargeId);
            }
            catch (ClientException ex)
            {
                ErrorUtils.HandleClientException(ex);
        ...
        static public string GetChargeID(string paymentGatewayExternalId)
        {
            ...
            try
            {
                ...
                // call client
                chargeId = ClientsManager.BillingClient().GetHouseholdChargeID(groupId, paymentGatewayExternalId, domainId);
            }
            catch (ClientException ex)
            {
                ErrorUtils.HandleClientException(ex);
