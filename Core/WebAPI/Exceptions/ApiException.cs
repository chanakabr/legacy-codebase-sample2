...
namespace WebAPI.Exceptions
{
    public class ApiException : HttpResponseException
    {
        ...
        public static ClientExceptionType SUBSCRIPTION_DOES_NOT_EXIST = new ClientExceptionType(eResponseStatus.SubscriptionDoesNotExist, "The subscription does not exist");
