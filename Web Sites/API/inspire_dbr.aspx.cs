...
public partial class inspire_dbr : System.Web.UI.Page
{
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while (iter.MoveNext() == true)
                        {
                            ...
                            //if (sEnding.Length == 1)
                            //sEnding = "0" + sEnding;
                            sRet += "<file bitrate=\"" + count + "\" only_fullscreen=\"false\">" + TVinciShared.ProtocolsFuncs.XMLEncode(u.Scheme + "://" + u.Host + sPathWithoutFile + sFile + "-" + sEnding + "." + sFileExt, true) + "</file>";
                            count++;
