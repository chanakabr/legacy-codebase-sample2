<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_batch_upload.aspx.cs" Inherits="adm_batch_upload" %>
								...
								<tr>
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <span style="font-size:13px; font-weight:bold;line-height:28px;">Generate Empty Excel template</span><br />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span style="font-size:13px; font-weight:bold;line-height:28px;">Number of files per media 
                                                    :&nbsp;
                                                    <asp:TextBox ID="TextBoxNumOfFiles" runat="server" Width="21px">1</asp:TextBox>
&nbsp;<asp:Label ID="LblGeneratorStatus" runat="server" Visible="False"></asp:Label></span><br />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Button ID="ButtonGenerator" runat="server" onclick="GetExcel" 
                                                        ...
                                                        PostBackUrl="~/adm_batch_upload.aspx" />
                                                </td>
                                            </tr>
                                             <tr>
                                                <td>
