<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_media_files_ppvmodules.aspx.cs" Inherits="adm_media_files_ppvmodules" %>
...
<body class="admin_body" onload="initDualObj()">
                        ...
                        <tr>
                            ...
                            <td style="width: 800px;" valign="top" nowrap>
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td onclick='window.document.location.href="adm_media_files.aspx?search_save=1&media_id=<% GetMeidaID(); %>";'><a href="#" class="btn_back"></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
