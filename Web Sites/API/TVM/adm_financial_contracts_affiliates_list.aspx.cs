...
public partial class adm_financial_contracts_affiliates_list : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_financial_contracts_affiliates_list_new.aspx", "Edit", "");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["LastContentPage"] = "adm_financial_contracts_affiliates_list.aspx?search_save=1";
