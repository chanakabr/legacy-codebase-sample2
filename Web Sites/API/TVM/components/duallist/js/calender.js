var Calendar = function (params, attachToElement) {
    ...
    var createCalendarComponent = function () {
        ...
        calendarComponent.classList.add('calendar-comp');

        var startDivInput = protoTypeDOM.cloneNode(false);
        startDivInput.classList.add('date');
        startDivInput.classList.add('start-date');
        ...
        endDivInput.classList.add('date');
        endDivInput.classList.add('end-date');
        ...
        startDateTooltip.classList.add('tooltip');
        startDateTooltip.classList.add('hidden');
        startDateTooltip.innerHTML = 'Date is invalid';

        var endDateTooltip = protoTypeDOM.cloneNode(false);
        endDateTooltip.classList.add('tooltip');
        endDateTooltip.classList.add('hidden');
        ...
        if (startDateNotEmpty || endDateNotEmpty) {
            attachToElement.classList.add('has-date');
            $(calendarComponent).find('input').attr('disabled','disabled');
        } else {
            calendarComponent.classList.add('hidden');
        }
