<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_user_dynamic_data.aspx.cs" Inherits="adm_user_dynamic_data" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum) {
        RS.Execute("adm_user_dynamic_data.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_user_dynamic_data.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
