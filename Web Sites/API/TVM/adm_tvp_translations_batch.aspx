<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_translations_batch.aspx.cs"
    Inherits="adm_tvp_translations_batch" %>
...
<head>
    ...
    <script type="text/javascript">
        function GetPageTable(orderBy, pageNum) {
            RS.Execute("adm_batch_upload.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
        }
                                ...
                                <tr>
                                    <td>
                                        <table>
                                             <tr>
                                                <td>
                                                    <asp:Button ID="ButtonGenerator" runat="server" onclick="GetExcel" 
                                                        CssClass="btn_generate" BorderStyle="None" 
                                                        PostBackUrl="~/adm_tvp_translations_batch.aspx" />
                                                        <br />
                                                        <br />
                                                </td>
                                            </tr>
    ...
    <div class="footer">
        <table>
            <tr>
                <td>
                    <div class="rights">
                        Copyright © 2009 Tvinci Ltd. All rights reserved. | +972 3 609 8070 | &nbsp;<a style="color: #0080ff;"
