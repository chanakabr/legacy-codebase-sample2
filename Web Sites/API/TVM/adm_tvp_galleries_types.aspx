<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_galleries_types.aspx.cs" Inherits="adm_tvp_galleries_types" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_galleries_types.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_galleries_types.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
