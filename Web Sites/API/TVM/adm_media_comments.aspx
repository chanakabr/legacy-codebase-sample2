<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_media_comments.aspx.cs" Inherits="adm_media_comments" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_media_comments.aspx", "GetPageContent", orderBy , pageNum , search_on_off , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_media_comments.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
