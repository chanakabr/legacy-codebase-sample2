<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_media_concurrency_rule.aspx.cs" Inherits="adm_media_concurrency_rule" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_media_concurrency_rule.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
