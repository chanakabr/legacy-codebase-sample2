<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_preview_modules.aspx.cs" Inherits="adm_preview_modules" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_preview_modules.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_preview_modules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
