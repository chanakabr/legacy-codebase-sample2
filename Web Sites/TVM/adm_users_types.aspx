<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_users_types.aspx.cs" Inherits="adm_users_types" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_users_types.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_users_types.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
