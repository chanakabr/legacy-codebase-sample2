<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_generic_lookup_table.aspx.cs" Inherits="adm_generic_lookup_table" %>
...
<head>
    ...
    <script type="text/javascript">
        function GetPageTable(orderBy, pageNum) {
            RS.Execute("adm_generic_lookup_table.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
        }
        function create_csv() {
            RS.Execute("adm_generic_lookup_table.aspx", "GetTableCSV", callback_create_csv, errorCallback);
        }
    </script>
</head>
