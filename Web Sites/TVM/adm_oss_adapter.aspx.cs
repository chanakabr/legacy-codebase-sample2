...
public partial class adm_oss_adapter : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable.AddActivationField("oss_adapter");

        DataTableLinkColumn linkColumnKeParams = new DataTableLinkColumn("adm_oss_adapter_config.aspx", "Params", "");
        linkColumnKeParams.AddQueryStringValue("oss_adapter_id", "field=id");
        linkColumnKeParams.AddQueryCounterValue("select count(*) as val from oss_adapter_config where ( status=1 or status = 4 )  and oss_adapter_id=", "field=id");
        theTable.AddLinkColumn(linkColumnKeParams);

        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_oss_adapter_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("oss_adapter_id", "field=id");
