<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_coupons_groups_new.aspx.cs" Inherits="adm_coupons_groups_new" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_coupons_groups_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
