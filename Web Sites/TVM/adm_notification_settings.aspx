<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_notification_settings.aspx.cs" Inherits="adm_notification_settings" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_notification_settings.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
