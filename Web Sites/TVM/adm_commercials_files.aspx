<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_commercials_files.aspx.cs" Inherits="adm_commercials_files" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_commercials_files.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_commercials_files.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="<% GetBackURL(); %>";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
