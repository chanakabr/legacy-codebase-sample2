...
function crearSelectorMes(mesActual) {
    ...
    var selectorMes = "";
	selectorMes = "<input class=calendarFormInput readonly=true type=text size=11 name='mes' value=" + getMonthByNum(mesActual) + ">";
	return selectorMes;
}
...
function crearTablaDias(numeroAno,numeroMes) {
	...
	var tabla = "<table dir='ltr' border='0' cellpadding='6' cellspacing='0'><tr class='calendarTableFooter'>";
...
function dibujarMes(numeroAno,numeroMes) {
	...
	html += "<tr dir='ltr'><td class=TableInner>";
	html += "<table dir='ltr' cellspacing=4 cellpadding=0 border=0 width=100%><tr>";
