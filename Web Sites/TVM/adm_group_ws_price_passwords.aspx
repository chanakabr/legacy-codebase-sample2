<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_group_ws_price_passwords.aspx.cs" Inherits="adm_group_ws_price_passwords" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_group_ws_price_passwords.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_group_ws_price_passwords.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
