...
public partial class adm_system_announcements_new : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (LoginManager.IsPagePermitted("adm_system_announcements.aspx") == false)
            LoginManager.LogoutFromSite("login.html");
        if (LoginManager.IsActionPermittedOnPage("adm_system_announcements.aspx", LoginManager.PAGE_PERMISION_TYPE.EDIT) == false)
            LoginManager.LogoutFromSite("login.html");
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["submited"] != null && Request.QueryString["submited"].ToString().Trim() == "1")
            {
                    ...
                    {
                        ImporterImpl.AddMessageAnnouncement(groupId, Enabled,name, message, recipients, date, timezone, ref id);//Notification   
            ...
            if (Request.QueryString["message_announcement_id"] != null &&
                Request.QueryString["message_announcement_id"].ToString() != "")
            {
