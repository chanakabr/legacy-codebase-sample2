<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_external_channels_enrichments.aspx.cs" Inherits="adm_external_channels_enrichments" %>
...
<body class="admin_body" onload="initDuallistObj('adm_external_channels_enrichments.aspx')">
                        ...
                        <tr>
                            ...
                            <td style="width: 800px;" valign="top" nowrap>
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td onclick='window.document.location.href="adm_external_channels.aspx?search_save=1&channel_id=<% GetExternalChannelId(); %>";'><a href="#" class="btn_back"></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
    ...
    <div class="footer">
        <table>
            <tr>
                <td>
                    <div class="rights">Copyright © 2006 Kaltura Ltd. All rights reserved. | +972 3 609 8070  | &nbsp;<a style="color: #0080ff;" tabindex="2000" href="mailto:info@kaltura.com">Contact Us</a></div>
                </td>
                <td>
