<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_gift_card_reminder.aspx.cs" Inherits="adm_gift_card_reminder" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {       
        RS.Execute("adm_gift_card_reminder.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {

        RS.Execute("adm_gift_card_reminder.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
