<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_collection_channels.aspx.cs" Inherits="adm_collection_channels" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_collection_channels.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_collection_channels.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
