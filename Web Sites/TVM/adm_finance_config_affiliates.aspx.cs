...
public partial class adm_finance_config_affiliates : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Affiliate management");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += ODBCWrapper.Parameter.NEW_PARAM("t.entity_type", "=", 2);
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_finance_config_affiliates_new.aspx", "Edit", "");
