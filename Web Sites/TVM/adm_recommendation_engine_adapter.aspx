<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_recommendation_engine_adapter.aspx.cs" Inherits="adm_recommendation_engine_adapter" %>
...
<script type="text/javascript">
	function GetPageTable(orderBy, pageNum) {
	    RS.Execute("adm_recommendation_engine_adapter.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
	}
	function create_csv() {
	    RS.Execute("adm_recommendation_engine_adapter.aspx", "GetTableCSV", callback_create_csv, errorCallback);
	}
</script>
</head>
