...
public partial class adm_financial_contracts_co_family_list : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ":" + PageUtils.GetTableSingleVal("fr_financial_entities", "NAME", int.Parse(Session["fr_parent_entity_id"].ToString())).ToString() + " Contracts families ");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += ODBCWrapper.Parameter.NEW_PARAM("t.PARENT_ENTITY_ID" , "=" , int.Parse(Session["fr_parent_entity_id"].ToString()));
        theTable += " and ";
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_financial_contracts_co_list.aspx", "Contracts", "");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["LastContentPage"] = "adm_financial_contracts_co_family_list.aspx?search_save=1";
