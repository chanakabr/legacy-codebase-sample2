...
public partial class adm_comment_filters : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select id as id,Text ,is_active, status from comment_filters where status<>2 and group_id = ";
        theTable += nGroupID.ToString();
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_comment_filters_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("filter_id", "field=id");
