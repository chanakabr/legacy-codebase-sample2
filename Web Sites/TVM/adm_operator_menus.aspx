<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_operator_menus.aspx.cs" Inherits="adm_operator_menus" %>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							...
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td  id="page_content" width=100% nowrap="True" runat="server">
								    </td>
								</tr>
							</table>
						</td>
...
<script type="text/javascript">
    function refreshMenuIdList(e) {

        var n = e.options[e.selectedIndex].value;
        var url = removeURLParameter(window.location.href, "subGroup");
        url += "&subGroup=" + n;
