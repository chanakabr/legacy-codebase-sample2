<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_financial_contracts_affiliates.aspx.cs" Inherits="adm_financial_contracts_affiliates" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_financial_contracts_affiliates.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_financial_contracts_affiliates.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
