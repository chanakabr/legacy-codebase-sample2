<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_bs_projects.aspx.cs" Inherits="adm_bs_projects" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_bs_projects.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_bs_projects.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
