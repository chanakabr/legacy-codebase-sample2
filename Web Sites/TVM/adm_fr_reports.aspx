<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_fr_reports.aspx.cs" Inherits="adm_fr_reports" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_fr_reports.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_fr_reports", "GetTableCSV", callback_create_csv, errorCallback);
    }

    function download_report(filename) {
        RS.Execute("adm_fr_reports.aspx", "DownloadReport", filename, callback_downloadreport, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<%--<tr>
								    <td onclick='window.document.location.href="adm_financial_contracts_co_family_list.aspx?search_save=1&fr_parent_entity_id=<% GetFamilyID(); %>";'><a href="#" class="btn_back"></a></td>
								</tr>--%>
							</table>
						</td>
					</tr>
