<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_reminder_template" Codebehind="adm_reminder_template.aspx.cs" %>
...
<head>
    ...
    <script type="text/javascript">
        function GetPageTable(orderBy, pageNum) {
            RS.Execute("adm_reminder_template.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
        }
    </script>
</head>
