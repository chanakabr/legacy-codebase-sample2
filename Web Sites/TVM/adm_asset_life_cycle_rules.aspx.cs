...
public partial class adm_asset_life_cycle_rules : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "asset_life_cycle_rules");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Asset Scheduling Rules");
    }
}
