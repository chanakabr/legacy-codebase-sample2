<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_pics_templates" Codebehind="adm_pics_templates.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_pics_templates.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_pics_templates.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
