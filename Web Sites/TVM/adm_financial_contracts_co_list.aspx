<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_financial_contracts_co_list.aspx.cs" Inherits="adm_financial_contracts_co_list" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_financial_contracts_co_list.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_financial_contracts_co_list.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
