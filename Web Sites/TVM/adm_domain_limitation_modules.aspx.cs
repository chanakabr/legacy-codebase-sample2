...
public partial class adm_domain_limitation_modules : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select a.is_active,a.id as id,a.NAME as 'Name', a.max_limit as 'Device Limit',  q1.DESCRIPTION as 'Device Frequency', a.concurrent_max_limit as 'Concurrent Limit', a.status, a.Home_network_quantity as 'Home networks limit', q2.DESCRIPTION as 'Home network frequency', env.description as 'Environment Type', a.user_max_limit as 'User Limit', q3.DESCRIPTION as 'User Frequency'";
        ...
        theTable += "left join (select lmp1.ID, lmp1.description  from lu_min_periods lmp1 with (nolock)) q3 on q3.ID=a.user_freq_period_id ";
