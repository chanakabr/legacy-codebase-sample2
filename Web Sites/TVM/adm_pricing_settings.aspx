<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_pricing_settings.aspx.cs" Inherits="adm_pricing_settings" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_pricing_settings.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
