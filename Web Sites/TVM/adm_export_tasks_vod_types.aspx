<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_export_tasks_vod_types.aspx.cs" Inherits="adm_export_tasks_vod_types" %>
...
<body class="admin_body" onload="initDuallistObj('adm_export_tasks_vod_types.aspx')">
                        ...
                        <tr>
                            ...
                            <td style="width: 800px;" valign="top" nowrap>
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td onclick='window.document.location.href="adm_export_tasks_vod_types.aspx?search_save=1&task_id=<% GetTaskId(); %>";'><a href="#" class="btn_back"></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
