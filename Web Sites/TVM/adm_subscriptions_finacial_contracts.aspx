<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_subscriptions_finacial_contracts.aspx.cs" Inherits="adm_subscriptions_finacial_contracts" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_subscriptions_finacial_contracts.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_subscriptions_finacial_contracts.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_finance_subscriptions_management.aspx?search_save=1&subscription_id=<% GetSubscriptionID(); %>";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
