...
public partial class adm_tvp_translations : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select t.is_active,t.id as id,t.TitleID as 'Token',t.CategoryToken as 'Location Token', t.status,lcs.description as 'State' from Translation t,lu_content_status lcs where lcs.id=t.status and t.status<>2 ";
        ...
        theTable.AddActivationField("Translation");
        theTable.AddHiddenField("is_active");
        theTable.AddTechDetails("Translation");

        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_tvp_translations_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("translation_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "Translation");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["ContentPage"] = "adm_tvp_translations.aspx";
        theTable.Finish();
        theTable = null;
        Response.Expires = -1;
        return sTable;
