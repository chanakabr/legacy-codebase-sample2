<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_financial_contracts_affiliates_list" Codebehind="adm_financial_contracts_affiliates_list.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_financial_contracts_affiliates_list.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_financial_contracts_affiliates_list.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
