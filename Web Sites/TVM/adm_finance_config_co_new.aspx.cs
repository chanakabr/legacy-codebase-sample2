...
public partial class adm_finance_config_co_new : System.Web.UI.Page
{
    ...
    {
        string sRet = PageUtils.GetPreHeader() + ": Content owners";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sBack = "adm_finance_config_co.aspx?search_save=1";
        ...
        DataRecordCheckBoxField dr_rh = new DataRecordCheckBoxField(true);
        dr_rh.Initialize("Is Right Holder", "adm_table_header_nbg", "FormInput", "is_right_holder", true);
        dr_rh.SetDefault(1);
        theRecord.AddRecord(dr_rh);

        string sTable = theRecord.GetTableHTML("adm_finance_config_co_new.aspx?submited=1");
