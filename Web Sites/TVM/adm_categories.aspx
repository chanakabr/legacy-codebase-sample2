<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_categories.aspx.cs" Inherits="adm_categories" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_categories.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_categories.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
