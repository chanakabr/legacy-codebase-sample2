<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_interests.aspx.cs" Inherits="adm_interests" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_interests.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
