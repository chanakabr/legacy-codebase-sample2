<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_alias_mapping_new.aspx.cs" Inherits="adm_alias_mapping_new" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_alias_mapping_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
