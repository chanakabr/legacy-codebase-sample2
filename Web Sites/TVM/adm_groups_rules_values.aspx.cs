...
public partial class adm_groups_rules_values : System.Web.UI.Page
{
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        selectQuery += "select mtt.id, mtt.name from groups_rules gr, media_tags_types mtt where";
        selectQuery += ODBCWrapper.Parameter.NEW_PARAM("gr.id", "=", t.ToString());
        selectQuery += "and gr.tag_type_id=mtt.id";
        ...
        if (selectQuery.Execute("query", true) != null)
        {
            ...
            for (int i = 0; i < nCount; i++)
            {
                ...
                DataRecordMultiField dr_tags = new DataRecordMultiField("tags", "id", "id", "groups_rules_values", "rule_id", "TAG_ID", true, "ltr", 60, "tags");
