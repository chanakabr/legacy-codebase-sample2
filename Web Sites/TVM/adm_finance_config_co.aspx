<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_finance_config_co.aspx.cs" Inherits="adm_finance_config_co" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_finance_config_co.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_config_co.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
