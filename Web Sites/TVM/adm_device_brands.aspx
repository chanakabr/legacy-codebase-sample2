<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_device_brands.aspx.cs" Inherits="adm_device_brands" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                //RS.Execute("adm_device_brands.aspx", "IsReachDeviceLimit", json.id, json.kindc, callback_IsReachDeviceLimit, errorCallback);
                RS.Execute("adm_device_brands.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function callback_IsReachDeviceLimit(ret) {
        if (ret) {
            alert('You have reached the limit of this device family');
    ...
    function initDualObj() {
        RS.Execute("adm_device_brands.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_device_management.aspx";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
