<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_profiles_new.aspx.cs" Inherits="adm_tvp_profiles_new" %>
...
<script type="text/javascript">
    ...
    var THE_PROFILE_ID='<%=Session["profile_loc"]%>';
    
    function AfterDateSelect(orderBy, pageNum, theDate) {
    }
    
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_tvp_profiles_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
