<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_group_regions_new.aspx.cs" Inherits="adm_group_regions_new" %>
...
<!-- dual list -->
<script type="text/javascript" src="components/duallist/js/number.js"></script>
<script type="text/javascript" src="components/duallist/js/script2.js"></script>
<script type="text/javascript" src="components/duallist/js/list2.js"></script>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute('adm_group_regions_new.aspx', 'GetPageContent', orderBy, pageNum, callback_page_content_with_editor, errorCallback);
        var dualList = document.getElementById("DualListPH");
        dualList.val(RS.Execute("adm_group_regions_new.aspx", "initDualObj", callback_init_dobj, errorCallback));
    }
