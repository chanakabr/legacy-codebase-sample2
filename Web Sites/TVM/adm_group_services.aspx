<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_group_services.aspx.cs" Inherits="adm_group_services" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_group_services.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_group_services.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
