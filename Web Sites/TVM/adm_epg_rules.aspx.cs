...
public partial class adm_epg_rules : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "lgrt.[DESCRIPTION] as 'EPG Rule Type', gr.dynamic_data_key as 'Dynamic Data Key', gr.status, gr.group_rule_type_id, gr.is_anonymous as 'is_anonymous' from";
