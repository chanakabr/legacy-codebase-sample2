<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_coupons_list_generator.aspx.cs" Inherits="adm_coupons_list_generator" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_coupons_list_generator.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);        
    }        
</script>
</head>
