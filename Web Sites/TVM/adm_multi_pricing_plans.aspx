...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_multi_pricing_plans.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_multi_pricing_plans.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
