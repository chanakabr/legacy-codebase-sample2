...
public partial class adm_my_group : System.Web.UI.Page
{
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        sQuery = "select name as txt,id as id from lu_npvr_providers where status=1 and is_active = 1";
        ...
        DataRecordMultiField dr_more_currencies = new DataRecordMultiField("pricing.dbo.lu_currency", "id", "id", "tvinci.dbo.group_extra_currencies", "GROUP_ID", "CURRENCY_ID", false, "ltr", 60, "tags");
        ...
        DataRecordShortTextField dr_mail_settings = new DataRecordShortTextField("ltr", true, 60, 128);
