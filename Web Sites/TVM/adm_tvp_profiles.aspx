<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_profiles.aspx.cs" Inherits="adm_tvp_profiles" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_profiles.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_profiles.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
