...
public partial class adm_series_reminder_template : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (LoginManager.IsPagePermitted("adm_series_reminder_template.aspx") == false)
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Series Reminder Template");
    }
    ...
    private MessageTemplate GetPageData()
    {
        ...
        MessageTemplate followTemplate = new MessageTemplate() { TemplateType = MessageTemplateType.SeriesReminder };
