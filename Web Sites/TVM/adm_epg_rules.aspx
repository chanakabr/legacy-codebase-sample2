<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_epg_rules.aspx.cs" Inherits="adm_epg_rules" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_rules.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_epg_rules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
