<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_epg_pic_popup_selector.aspx.cs" Inherits="adm_epg_pic_popup_selector" %>
...
<HEAD>
		...
		<script type="text/javascript">
            ...
            {
                RS.Execute("adm_epg_pic_popup_selector.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
            }
            //function SearchPics()
            //{
        ...
        <div class="wrapper">
            <div id="pic_b">
	           ...
	           <%-- <div class="find"><b class="top"><b></b></b>
		            ...
		            <input name='pics_tag_coll' id='pics_tag_coll' name="" type="text" onkeyup='return tagKeyPress("tags" , "pics_tags" , "VALUE" , "adm_table_header_nbg" , "tag_type_id=0" , "pics_tag" , "");'/>
		            </label>
