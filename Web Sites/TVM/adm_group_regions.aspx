<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_group_regions.aspx.cs" Inherits="adm_group_regions" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_group_regions.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_group_regions.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
