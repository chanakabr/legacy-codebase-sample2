...
public partial class adm_payment_gateway_config : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ":" + " Payment Gateway values");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += " from payment_gateway_config ";
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_payment_gateway_config_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("payment_gateway_config_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_payment_gateway.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "payment_gateway_config");
