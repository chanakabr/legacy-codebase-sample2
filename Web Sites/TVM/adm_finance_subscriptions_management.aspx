<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_finance_subscriptions_management.aspx.cs" Inherits="adm_finance_subscriptions_management" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_finance_subscriptions_management.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_subscriptions_management.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
