<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_edit_group_members.aspx.cs" Inherits="adm_edit_group_members" %>
...
<script type="text/javascript">
    function editGroup() {
        ...
        submitASPFormWithCheck("adm_edit_group_members.aspx?selectedIndex=" + selectedIndex + "&groupName=" + groupName);
    }
</script>

</head>
<body class="admin_body" onload="initDuallistObj('adm_edit_group_members.aspx')">
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td>                                  
                                        <label>Select Group And Confirm To Edit Members</label>
