...
public partial class adm_reminder_template : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (LoginManager.IsPagePermitted("adm_reminder_template.aspx") == false)
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Reminder Template");
    }
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        int tableID = GetReminderTemplateId(ODBCWrapper.Utils.GetIntSafeVal(groupId));
        ...
        else
        {
            ...
            string sBack = "adm_reminder_template.aspx?search_save=1";
            ...
            sTable = theRecord.GetTableHTML("adm_reminder_template.aspx?submited=1");
        }
        return sTable;
    }

    private int GetReminderTemplateId(int groupID)
    {
        ...
        try
        {
            ...
            selectQuery += "select ID, Message, date_format from message_templates where status=1 and asset_type=2 and";
            ...
            if (selectQuery.Execute("query", true) != null)
            {
                ...
                if (nCount > 0)
                {
                    templateId = ODBCWrapper.Utils.GetIntSafeVal(selectQuery.Table("query").DefaultView[0].Row, "ID");
                }
            }
            selectQuery.Finish();
            selectQuery = null;
