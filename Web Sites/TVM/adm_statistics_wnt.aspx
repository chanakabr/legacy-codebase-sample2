<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_statistics_wnt.aspx.cs" Inherits="adm_statistics_wnt" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_statistics_wnt.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_statistics_wnt.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
