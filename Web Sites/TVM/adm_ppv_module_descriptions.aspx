<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_ppv_module_descriptions.aspx.cs" Inherits="adm_ppv_module_descriptions" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_ppv_module_descriptions.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_ppv_module_descriptions.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_ppv_modules.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
