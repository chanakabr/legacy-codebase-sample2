<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_finance_contracts_processors_limitations.aspx.cs" Inherits="adm_finance_contracts_processors_limitations" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_finance_contracts_processors_limitations.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_contracts_processors_limitations.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_finance_contracts_processors.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
