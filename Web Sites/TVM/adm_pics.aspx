<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_pics.aspx.cs" Inherits="adm_pics" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_pics.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_pics.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
