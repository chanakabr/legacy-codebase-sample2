<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_statistics_wph.aspx.cs" Inherits="adm_statistics_wph" %>
...
<script type="text/javascript">
    ...
    function putError(theError)
    {
        document.getElementById("error_place").innerHTML = "* " + theError;
    }
    function reloadPage()
    {
        try
        {
            ...
            document.location.href = "adm_statistics_wph.aspx?start_date=" + strStart + "&end_date=" + strEnd;
         }
         catch(theEx)
         {
