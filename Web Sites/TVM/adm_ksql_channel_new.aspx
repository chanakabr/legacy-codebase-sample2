<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_ksql_channel_new.aspx.cs" Inherits="adm_ksql_channel_new" %>
...
<script type="text/javascript">
	function GetPageTable(orderBy, pageNum) {
	    RS.Execute("adm_ksql_channel_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
	}
</script>
...
(
 ...
 'movie', 'flash/DualList'
			...
			switch (json.eventType) {
				case "move":
					if (json.callerID == 'DualList') {
					    RS.Execute("adm_ksql_channel_new.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
					}
					break;
				case "ready":
					if (json.id == 'DualList') {
		...
		function initDualObj() {
		    RS.Execute("adm_ksql_channel_new.aspx", "initDualObj", callback_init_dobj, errorCallback);
		}
