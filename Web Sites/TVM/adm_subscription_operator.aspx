<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_subscription_operator.aspx.cs" Inherits="adm_subscription_operators" %>
...
<body class="admin_body" onload="initDuallistObj('adm_subscription_operator.aspx')">
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_subscriptions.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
