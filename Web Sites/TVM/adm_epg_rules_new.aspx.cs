...
public partial class adm_epg_rules_new : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": EPG rule values");
    }
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        DataRecordDropDownField dr_tag_type = new DataRecordDropDownField("epg_tags_types", "NAME", "id", "", null, 60, true);
        string sQuery = "select name as txt,id as id from epg_tags_types where status=1 and group_id= " + LoginManager.GetLoginGroupID().ToString();
        ...
        /////////
        // Make sure to set the rule type as 2 instead of the default value 1
        /////////
        //DataRecordDropDownField dr_group_rule_type = new DataRecordDropDownField("lu_group_rule_types", "NAME", "id", "", null, 60, false);
        //string sEpgRulesTypesQuery = "select description as txt,id as id from lu_group_rule_types";
        //dr_group_rule_type.SetSelectsQuery(sEpgRulesTypesQuery);
