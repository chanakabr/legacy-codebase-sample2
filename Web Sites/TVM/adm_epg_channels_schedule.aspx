<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_epg_channels_schedule.aspx.cs" Inherits="adm_epg_channels_schedule" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_epg_channels_schedule.aspx", "GetPageContent", orderBy, pageNum, startD, startM, startY, endD, endM, endY, callback_page_content, errorCallback);
    }
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_epg_channels.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
