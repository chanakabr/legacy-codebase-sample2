...
public partial class adm_finance_config_tax : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Tax contracts management");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_finance_config_tax_new.aspx", "Edit", "");
