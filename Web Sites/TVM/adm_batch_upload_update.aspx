<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_batch_upload_update.aspx.cs" Inherits="adm_batch_upload_update" %>
...
<body class="admin_body" onload="initDuallistObj('adm_batch_upload_update.aspx')">
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td>
                                        <span style="font-size:13px; font-weight:bold;line-height:28px;">Generate Excel template with medias</span><br />
                                    </td>
                                </tr>
                                <tr>
								    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="ButtonGenerator" runat="server" onclick="GetExcel" 
                                            ...
                                            PostBackUrl="~/adm_batch_upload_update.aspx" />
                                    </td>
                                </tr>
							</table>
						</td>
