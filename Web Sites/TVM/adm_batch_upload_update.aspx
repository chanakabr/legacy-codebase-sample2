...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_batch_upload_update.aspx", "changeItemStatus", json.id, json.kind, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_batch_upload_update.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
