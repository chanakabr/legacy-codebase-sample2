<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_recommendation_engine_adapter_new.aspx.cs" Inherits="adm_recommendation_engine_adapter_new" %>
...
<script type="text/javascript">
	function GetPageTable(orderBy, pageNum) {
		RS.Execute("adm_recommendation_engine_adapter_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
	}
	function create_csv() {
		RS.Execute("adm_recommendation_engine_adapter_new.aspx", "GetTableCSV", callback_create_csv, errorCallback);
	}
</script>
</head>
