...
public partial class adm_tvp_footers_items : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Int32 nMenuID = 0;
            m_sMenu = TVinciShared.Menu.GetMainMenu(14, true, ref nMenuID, "adm_tvp_footers.aspx");
    ...
    public void GetBackLink()
    {
        ...
        string sBack = "adm_tvp_footers.aspx";
        ...
        if (Session["menu_item_parent_id"].ToString() != "0")
            sBack = "adm_tvp_footers_items.aspx?search_save=1&menu_id=" + Session["menu_id"].ToString() + "&menu_item_parent_id=" + sParent;
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        //theTable.AddHiddenField("order_num");
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_tvp_footers_items.aspx", "Items", "");
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_tvp_footers.aspx", LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_tvp_footers_items_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("tvp_menu_item_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }

        if (LoginManager.IsActionPermittedOnPage("adm_tvp_footers.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_tvp_footers.aspx", LoginManager.PAGE_PERMISION_TYPE.PUBLISH))
        {
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["ContentPage"] = "adm_tvp_footers.aspx";
        Session["LastContentPage"] = "adm_tvp_footers_items.aspx?search_save=1&menu_id=" + Session["menu_id"].ToString() + "&menu_item_parent_id=" + Session["menu_item_parent_id"].ToString();
        theTable.Finish();
        theTable = null;
        return sTable;
    }
    ...
    protected string GetWhereAmIStr(string sMenuName)
    {
        ...
        sRet = "<span style=\"cursor:pointer;\" onclick=\"document.location.href='adm_tvp_menu.aspx?menu_id=" + Session["menu_id"].ToString() + "';\">Footer: " + sMenuName + " </span><span class=\"arrow\">&raquo; </span>" + sRet;
        return sRet;
    ...
    public void GetHeader()
    {
        ...
        Response.Write(PageUtils.GetPreHeader() + ": Footer Items : " + GetWhereAmIStr(sMenuName));
    }
}
