<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_finance_config_tax.aspx.cs" Inherits="adm_finance_config_tax" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_finance_config_tax.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_config_tax.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
