...
public partial class adm_finance_config_co : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Content owners management");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "where status<>2 and PARENT_ENTITY_ID=0 and ";
