<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_fr_report_generate" Codebehind="adm_fr_report_generate.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_fr_report_generate.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							...
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                                <td></br>
                                                    <span style="font-size:13px; font-weight:bold;line-height:28px;">Generate a financial reports between the following dates :</span><br />
                                                </td>
                                            </tr>
								<tr>
                               ...
                               <tr ><td id="confirm_btn" onclick='submitASPForm("adm_fr_report_generate.aspx?submitted=1")'><a tabindex="2000" href="javascript:void(0)" class="btn"></a></td></tr>
