<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_commercials_statistics.aspx.cs" Inherits="adm_commercials_statistics" %>
									    ...
									    <table width=100%>
			                                ...
			                                <tr>
			                                    <td>
			                                        ...
			                                        <script type="text/javascript">
			                                            <% GetMediaMounthViewsCountStatistics(4); %>
                                                    </script>
                                                    </div>
			                                    </td>
			                                    <td >
			                                        <div  style="position:relative; top:0px; height:220px;">
			                                        <script type="text/javascript">
			                                            <% GetMediaDayViewCountStatistics(4); %>
                                                    </script>
                                                    </div>
			                                    </td>
			                                </tr>
			                                <tr>
			                                    <td>
			                                        <div  style="position:relative; top:0px; height:220px;">
			                                        <script type="text/javascript">
			                                            <% GetMediaMounthViewsCountStatistics(5); %>
                                                    </script>
                                                    </div>
			                                    </td>
			                                    <td >
			                                        <div  style="position:relative; top:0px; height:220px;">
			                                        <script type="text/javascript">
			                                            <% GetMediaDayViewCountStatistics(5); %>
                                                    </script>
                                                    </div>
			                                    </td>
			                                </tr>
