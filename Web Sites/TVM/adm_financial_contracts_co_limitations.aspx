<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_financial_contracts_co_limitations.aspx.cs" Inherits="adm_financial_contracts_co_limitations" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_financial_contracts_co_limitations.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_financial_contracts_co_limitations.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
