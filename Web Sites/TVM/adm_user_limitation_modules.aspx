<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_user_limitation_modules.aspx.cs" Inherits="adm_user_limitation_modules" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_user_limitation_modules.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_user_limitation_modules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
