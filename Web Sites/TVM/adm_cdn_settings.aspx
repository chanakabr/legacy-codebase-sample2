<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_cdn_settings.aspx.cs" Inherits="adm_cdn_settings" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_cdn_settings.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
