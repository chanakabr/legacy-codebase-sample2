<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_external_channels.aspx.cs" Inherits="adm_external_channels" %>
...
<script type="text/javascript">
	function GetPageTable(orderBy, pageNum) {
		...
		RS.Execute("adm_external_channels.aspx", "GetPageContent", orderBy, pageNum, search_free, callback_page_content, errorCallback);
	}
	function create_csv() {
		RS.Execute("adm_external_channels.aspx", "GetTableCSV", callback_create_csv, errorCallback);
	}
</script>
</head>
													...
													<td>
														<table width="100%">
															<tr>
																...
																<td class="space01">&nbsp;&nbsp;</td>
																<%--<td><% TVinciShared.DBTableWebEditor.GetSearchSelectOptions("Channel Owner", "search_channel_type", "lu_channel_owner", "id", "DESCRIPTION", "ID DESC", "", "0", false  , ""); %></td>--%>
