...
public partial class adm_subscription_descriptions : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select pcd.id as id,pcd.language_code3 as 'Language',pcd.description as 'Description',pcd.status,lcs.description as 'State' from subscription_descriptions pcd,lu_content_status lcs where lcs.id=pcd.status and pcd.status<>2 and ";
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_subscription_descriptions_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("subscription_description_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_subscriptions.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "subscription_descriptions");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["LastContentPage"] = "adm_subscription_descriptions.aspx?subscription_id=" + Session["subscription_id"].ToString();
        theTable.Finish();
        theTable = null;
        return sTable;
    }
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Subscription (" + Session["subscription_id"].ToString() + ") descriptions");
    }
}
