<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_layout.aspx.cs" Inherits="adm_tvp_layout" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_layout.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_layout.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
