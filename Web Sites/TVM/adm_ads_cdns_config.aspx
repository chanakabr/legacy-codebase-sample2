<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_ads_cdns_config" Codebehind="adm_ads_cdns_config.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_ads_cdns_config.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_ads_cdns_config.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
