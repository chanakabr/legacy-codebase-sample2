<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_services.aspx.cs" Inherits="adm_services" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_services.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_services.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
    function StopService(theServiceID)
    {
        RS.Execute("adm_services.aspx", "ChangeServiceStatus" , "Stop" , theServiceID , callback_change_service_status, errorCallback);
    }
    function StartService(theServiceID)
    {
        RS.Execute("adm_services.aspx", "ChangeServiceStatus" , "Start" , theServiceID , callback_change_service_status, errorCallback);
    }
    function callback_change_service_status(ret)
    {
        alert(ret);
    }
</script>
...
<div class="footer">
	<table>
		<tr>
			<td>
				<div class="rights"> Copyright © 2006 Kaltura Ltd. All rights reserved. | +972 3 609 8070  | &nbsp;<a style="color:#0080ff;" tabindex="2000" href="mailto:info@tvinci.com">Contact Us</a></div></td><td ><img src="images/admin-footerLogo.png" alt="Kaltura" />
			</td>
		</tr>
	</table>
</div>
