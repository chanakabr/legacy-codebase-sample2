<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_generic_remove" Codebehind="adm_generic_remove.aspx.cs" %>
                                    ...
                                    <tr valign=top>
                                        ...
                                        <td style="width:100%; white-space: nowrap;" nowrap valign=top>
                                            <table width=100% cellpadding=0 cellspacing=0>
                                                <!-- header -->
                                                <tr>
                                                    <td class=adm_main_header nowrap width=100%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;מחיקת רשומות&nbsp;&nbsp;</td>
                                                </tr>
		                                        <!-- top menu area-->
