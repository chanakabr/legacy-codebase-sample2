<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_channels.aspx.cs" Inherits="adm_channels" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        search_channel_type = GetSafeDocumentIDVal("search_channel_type");
        RS.Execute("adm_channels.aspx", "GetPageContent", orderBy , pageNum , search_free , search_channel_type,callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_channels.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
    function ShowIframe() 
    {
        document.getElementById("player_frame").src = "admin_tree_player.aspx";        
    }
</script>
</head>
								    ...
								    <td>
										<div>
											<table>
												<tr>
									                <td>
									                    <IFRAME id="player_frame" name="player_frame" SRC="" WIDTH="800px" HEIGHT="300px" FRAMEBORDER="0"></IFRAME>
									                </td>
												</tr>
											</table>
										</div>
