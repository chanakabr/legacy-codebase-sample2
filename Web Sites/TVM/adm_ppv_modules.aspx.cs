...
public partial class adm_ppv_modules : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select ppm.is_active,ppm.id as id,ppm.NAME as 'Code',ppm.ID as 'PPV Module ID',ppm.status,lcs.description as 'State', 'First Device Limitation' = case when isnull(ppm.FirstDeviceLimitation,0) = 0  then 'False' else 'True' END from ppv_modules ppm,lu_content_status lcs where lcs.id=ppm.status and ppm.status<>2 and ";
        ...
        */
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_ppv_modules_file_types.aspx", "File Types", "");
            linkColumn1.AddQueryStringValue("ppv_module_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_ppv_modules_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("ppv_module_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "ppv_modules");
