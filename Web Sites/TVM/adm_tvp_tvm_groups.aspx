<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_tvm_groups.aspx.cs" Inherits="adm_tvp_tvm_groups" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_tvm_groups.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_tvm_groups.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
