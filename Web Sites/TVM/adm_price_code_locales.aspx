<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_price_code_locales.aspx.cs" Inherits="adm_price_code_locales" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_price_code_locales.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_price_code_locales.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_price_codes.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
