<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_limitation_modules_new.aspx.cs" Inherits="adm_limitation_modules_new" %>
...
(
    ...
    function GetPageTable(orderBy, pageNum) {
        ...
        RS.Execute("adm_limitation_modules_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }

    function initDualObj() {
        RS.Execute("adm_limitation_modules_new.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
