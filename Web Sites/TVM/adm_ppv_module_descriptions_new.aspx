<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_ppv_module_descriptions_new.aspx.cs" Inherits="adm_ppv_module_descriptions_new" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_ppv_module_descriptions_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							...
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="<% GetBackLink(); %>";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
