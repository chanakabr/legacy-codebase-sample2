<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_create_permissions_group.aspx.cs" Inherits="adm_create_permissions_group" %>
...
<script type="text/javascript">
    function createGroup() {
        ...
        var userID = usersList.options[selectedIndex].value;
        var groupName = document.getElementById('groupNameSource').value;
        submitASPFormWithCheck("adm_create_permissions_group.aspx?selectedIndex=" + selectedIndex + "&userID=" + userID + "&NewGroupName=" + groupName);
    }
</script>
							...
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td style="padding-bottom: .5em">
                                        <label>Enter New Group Name, Select User To Assign To The New Group And Then Confirm</label>
                                    </td>
                                </tr>      
                                <tr>
                                    <td style="padding-bottom: .5em">                                  
                                        <label>New Group Name</label>                                        
                                        <input id="groupNameSource" runat="server"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: .5em">                                                                          
                                ...
                                <tr style="padding-bottom: .5em">
                                    <td id="confirm_btn" onclick='createGroup();'>
