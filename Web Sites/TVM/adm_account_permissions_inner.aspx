<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_account_permissions_inner.aspx.cs" Inherits="adm_account_permissions_inner" %>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td id="back_btn" onclick='window.document.location.href="adm_account_permissions.aspx";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
