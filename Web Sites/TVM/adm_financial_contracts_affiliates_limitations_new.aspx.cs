...
public partial class adm_financial_contracts_affiliates_limitations_new : System.Web.UI.Page
{
    ...
    {
        string sRet = PageUtils.GetPreHeader() + ": Affiliates monthly limitations";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sBack = "adm_financial_contracts_affiliates_limitations.aspx?search_save=1";
        ...
        string sTable = theRecord.GetTableHTML("adm_financial_contracts_affiliates_limitations_new.aspx?submited=1");
