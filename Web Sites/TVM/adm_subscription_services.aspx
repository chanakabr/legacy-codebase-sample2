<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_subscription_services.aspx.cs" Inherits="adm_subscription_services" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_subscription_services.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_subscription_services.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_multi_pricing_plans.aspx";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
