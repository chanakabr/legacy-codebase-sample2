<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_coupons_list.aspx.cs" Inherits="adm_coupons_list" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum) {
        ...
        RS.Execute("adm_coupons_list.aspx", "GetPageContent", orderBy, pageNum, search_free, search_on_off , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_coupons_list.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_coupons_groups.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
