<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_tvp_galleries_items_links_new.aspx.cs" Inherits="adm_tvp_galleries_items_links_new" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_tvp_galleries_items_links_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
