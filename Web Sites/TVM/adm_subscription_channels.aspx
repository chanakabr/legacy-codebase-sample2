...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_subscription_channels.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_subscription_channels.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
