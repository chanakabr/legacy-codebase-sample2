<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_collection_product_codes" Codebehind="adm_collection_product_codes.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_collection_product_codes.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
