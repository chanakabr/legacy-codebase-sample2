...
public partial class adm_interest_epg_template : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (LoginManager.IsPagePermitted("adm_interest_epg_template.aspx") == false)
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Interest EPG Template");
    }
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        int tableID = GetTemplateId(ODBCWrapper.Utils.GetIntSafeVal(groupId));
        ...
        else
        {
            ...
            string sBack = "adm_interest_epg_template.aspx?search_save=1";
            ...
            sTable = theRecord.GetTableHTML("adm_interest_epg_template.aspx?submited=1");
        }
        return sTable;
    }
    ...
    private int GetTemplateId(int groupID)
    {
        ...
        try
        {
            ...
            selectQuery += string.Format("select ID, Message, date_format from message_templates where status=1 and asset_type={0} and", (int)MessageTemplateType.InterestEPG);
    ...
    private MessageTemplate GetPageData()
    {
        ...
        MessageTemplate followTemplate = new MessageTemplate() { TemplateType = MessageTemplateType.InterestEPG };
