...
public partial class adm_users_list_excel : System.Web.UI.Page
{
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        int minUserID = 0;
        int maxUserID = 0;
        DataTable dt = DAL.UsersDal.getUserMinMaxID(LoginManager.GetLoginGroupID(), nBulk, ref minUserID, ref maxUserID);
        Session["minUserID"] = minUserID;
        Session["maxUserID"] = maxUserID;
