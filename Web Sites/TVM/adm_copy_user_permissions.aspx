<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_copy_user_permissions.aspx.cs" Inherits="adm_copy_user_permissions" %>
...
<script type="text/javascript">
    function copyUser() {
        var sourceusersList = document.getElementById('usersSource');
        var sourceSelectedIndex = sourceusersList.selectedIndex;
        var sourceUserID = sourceusersList.options[sourceSelectedIndex].value;
        var destinationUsersList = document.getElementById('usersDestination');
        var destinationSelectedIndex = destinationUsersList.selectedIndex;
        var destinationUserID = destinationUsersList.options[destinationSelectedIndex].value;
        submitASPFormWithCheck("adm_copy_user_permissions.aspx?selectedSourceIndex=" + sourceSelectedIndex + "&sourceUserID=" + sourceUserID +
                                "&selectedDestinationIndex=" + destinationSelectedIndex + "&destinationUserID=" + destinationUserID);
    }
</script>
							...
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td style="padding-bottom: .5em">
                                        <label>Select Source And Destination User To Copy Permissions And Confirm</label>
                                    </td>
                                </tr>      
                                <tr>
                                    <td style="padding-bottom: .5em">                                  
                                        <label>Source User</label>
                                        <select id="usersSource" runat="server" />                  
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: .5em">                                                                          
                                        <label>Destination User</label>
                                        <select id="usersDestination" runat="server" />                  
                                    </td>
                                </tr>
                                <tr style="padding-bottom: .5em">
                                    <td id="confirm_btn" onclick='copyUser();'>
                                        <a tabindex="2000" href="#confirm_btn" class="btn"></a>
                                    </td>
                                </tr>                                                          
                                <tr>
                                    <td style="padding-top: .5em">
                                        <label id="actionResponse" runat="server" />
                                    </td>
                                </tr>                                               
							</table>
						</td>
...
<div class="footer">
	<table>
		<tr>
			<td>
				<div class="rights"> Copyright © 2009 Kaltura Ltd. All rights reserved. | +972 3 609 8070  | &nbsp;<a style="color:#0080ff;" tabindex="2000" href="mailto:info@kaltura.com">Contact Us</a></div></td><td ><img src="images/admin-footerLogo.png" alt="Kaltura" />
			</td>
		</tr>
	</table>
</div>
