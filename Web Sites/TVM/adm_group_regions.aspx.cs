...
public partial class adm_group_regions : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_group_regions_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("region_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "linear_channels_regions");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Regions");
    }
}
