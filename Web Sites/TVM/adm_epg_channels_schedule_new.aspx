<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_epg_channels_schedule_new.aspx.cs" Inherits="adm_epg_channels_schedule_new" %>
...
<script type="text/javascript">
    ...
    var Fr = '<%=Session["Fr"]%>';
    var Sa = '<%=Session["Sa"]%>';
    var MonthNumber = Array('','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
    function AfterDateSelect(orderBy, pageNum, theDate) {
    }
    function GetPageTable(orderBy , pageNum)
    {
        RS.Execute("adm_epg_channels_schedule_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
