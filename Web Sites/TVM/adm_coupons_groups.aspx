...
<script type="text/javascript">
    ...
    function CouponGenerator(coupon_group_id) {
        ...
        theHtml += "<td><input type='checkbox' class='FormInput' id='use_letters' name='use_letters' checked /></td>";
        theHtml += "</tr>";
        theHtml += "<tr>";
        theHtml += "<td class='adm_table_header_nbg' nowrap>Use numbers</td>";
        theHtml += "<td><input type='checkbox' class='FormInput' id='use_numbers' name='use_numbers' checked /></td>";
        theHtml += "</tr>";
        theHtml += "<tr>";
        theHtml += "<td class='adm_table_header_nbg' nowrap>Use special characters (@#$?)</td>";
        theHtml += "<td><input type='checkbox' class='FormInput' id='use_special_characters' name='use_special_characters' checked/></td>";
        theHtml += "</tr>";
        theHtml += "<tr>";
