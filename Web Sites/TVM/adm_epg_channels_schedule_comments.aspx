<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_epg_channels_schedule_comments.aspx.cs" Inherits="adm_epg_channels_schedule_comments" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        ...
        RS.Execute("adm_epg_channels_schedule_comments.aspx", "GetPageContent", orderBy, pageNum, search_on_off, search_free, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_epg_channels_schedule_comments.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_media.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
