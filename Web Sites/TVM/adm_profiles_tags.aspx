<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_profiles_tags.aspx.cs" Inherits="adm_profiles_tags" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_profiles_tags.aspx", "GetPageContent", orderBy, pageNum, search_tag_type, search_free, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_profiles_tags.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
											...
											<table>
												<tr>
													<td>
														<table width="100%">
															<tr>
																<td><% TVinciShared.DBTableWebEditor.GetSearchSelectOptionsExp("Profile Tag description", "search_tag_type", "profile_tags_types", "id", "description", "ID", "---", "-1", true, "select distinct id from profile_tags_types where id=0 or group_id=" + TVinciShared.LoginManager.GetLoginGroupID().ToString() , ""); %></td>
																<td class="space01">&nbsp;&nbsp;</td>
