...
namespace ConfigurationManager
{
    public class SocialFeedQueueConfiguration : BaseConfig<SocialFeedQueueConfiguration>
    {
        ...
        public BaseValue<string> TaskSocialMerge = new BaseValue<string>("taskSocialMerge", null);
        public BaseValue<string> RoutingKeyMerge = new BaseValue<string>("routingKeySocialFeedMerge", null);
