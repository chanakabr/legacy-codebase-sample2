...
namespace AdapterControllers.RecommendationEngineAdapter {
    ...
    public interface IService {
        ...
        AdapterControllers.RecommendationEngineAdapter.AdapterStatus SetConfiguration(int recommendationEngineId, AdapterControllers.RecommendationEngineAdapter.KeyValue[] configurations, int partnerId, long timeStamp, string signature);
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<AdapterControllers.RecommendationEngineAdapter.IService>, AdapterControllers.RecommendationEngineAdapter.IService {
        ...
        public AdapterControllers.RecommendationEngineAdapter.AdapterStatus SetConfiguration(int recommendationEngineId, AdapterControllers.RecommendationEngineAdapter.KeyValue[] configurations, int partnerId, long timeStamp, string signature) {
            return base.Channel.SetConfiguration(recommendationEngineId, configurations, partnerId, timeStamp, signature);
        }
