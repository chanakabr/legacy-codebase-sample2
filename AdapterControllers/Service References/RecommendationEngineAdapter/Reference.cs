...
namespace AdapterControllers.RecommendationEngineAdapter {
    ...
    public interface IService {
        ...
        AdapterControllers.RecommendationEngineAdapter.RecommendationsResult GetRelatedRecommendations(int recommendationEngineId, int mediaId, int mediaTypeId, string userId, int deviceId, string language, AdapterControllers.RecommendationEngineAdapter.KeyValue[] enrichments, int[] filterTypeIds, int utcOffset, int pageIndex, int pageSize, long timeStamp, string signature);
        ...
        AdapterControllers.RecommendationEngineAdapter.RecommendationsResult GetSearchRecommendations(int recommendationEngineId, string query, string userId, int deviceId, string language, AdapterControllers.RecommendationEngineAdapter.KeyValue[] enrichments, int[] filterTypeIds, int utcOffset, int pageIndex, int pageSize, long timeStamp, string signature);
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<AdapterControllers.RecommendationEngineAdapter.IService>, AdapterControllers.RecommendationEngineAdapter.IService {
        ...
        public AdapterControllers.RecommendationEngineAdapter.RecommendationsResult GetRelatedRecommendations(int recommendationEngineId, int mediaId, int mediaTypeId, string userId, int deviceId, string language, AdapterControllers.RecommendationEngineAdapter.KeyValue[] enrichments, int[] filterTypeIds, int utcOffset, int pageIndex, int pageSize, long timeStamp, string signature) {
