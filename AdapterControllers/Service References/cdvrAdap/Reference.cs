...
namespace AdapterControllers.cdvrAdap {
    ...
    public interface IService {
        ...
        AdapterControllers.cdvrAdap.RecordingResponse GetRecordingStatus(string recordingId, int adapterId, long timeStamp, string signature);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetRecordingStatus", ReplyAction="http://tempuri.org/IService/GetRecordingStatusResponse")]
        System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> GetRecordingStatusAsync(string recordingId, int adapterId, long timeStamp, string signature);
        ...
        AdapterControllers.cdvrAdap.RecordingResponse UpdateRecordingSchedule(string recordingId, int adapterId, long startDateSeconds, long durationSeconds, long timeStamp, string signature);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/UpdateRecordingSchedule", ReplyAction="http://tempuri.org/IService/UpdateRecordingScheduleResponse")]
        System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> UpdateRecordingScheduleAsync(string recordingId, int adapterId, long startDateSeconds, long durationSeconds, long timeStamp, string signature);
        ...
        AdapterControllers.cdvrAdap.RecordingResponse CancelRecording(string recordingId, int adapterId, long timeStamp, string signature);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/CancelRecording", ReplyAction="http://tempuri.org/IService/CancelRecordingResponse")]
        System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> CancelRecordingAsync(string recordingId, int adapterId, long timeStamp, string signature);
        ...
        AdapterControllers.cdvrAdap.RecordingResponse DeleteRecording(string recordingId, int adapterId, long timeStamp, string signature);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/DeleteRecording", ReplyAction="http://tempuri.org/IService/DeleteRecordingResponse")]
        System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> DeleteRecordingAsync(string recordingId, int adapterId, long timeStamp, string signature);
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<AdapterControllers.cdvrAdap.IService>, AdapterControllers.cdvrAdap.IService {
        ...
        public AdapterControllers.cdvrAdap.RecordingResponse GetRecordingStatus(string recordingId, int adapterId, long timeStamp, string signature) {
            return base.Channel.GetRecordingStatus(recordingId, adapterId, timeStamp, signature);
        }
        
        public System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> GetRecordingStatusAsync(string recordingId, int adapterId, long timeStamp, string signature) {
            return base.Channel.GetRecordingStatusAsync(recordingId, adapterId, timeStamp, signature);
        }
        
        public AdapterControllers.cdvrAdap.RecordingResponse UpdateRecordingSchedule(string recordingId, int adapterId, long startDateSeconds, long durationSeconds, long timeStamp, string signature) {
            return base.Channel.UpdateRecordingSchedule(recordingId, adapterId, startDateSeconds, durationSeconds, timeStamp, signature);
        }
        
        public System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> UpdateRecordingScheduleAsync(string recordingId, int adapterId, long startDateSeconds, long durationSeconds, long timeStamp, string signature) {
        ...
        public AdapterControllers.cdvrAdap.RecordingResponse CancelRecording(string recordingId, int adapterId, long timeStamp, string signature) {
            return base.Channel.CancelRecording(recordingId, adapterId, timeStamp, signature);
        }
        
        public System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> CancelRecordingAsync(string recordingId, int adapterId, long timeStamp, string signature) {
            return base.Channel.CancelRecordingAsync(recordingId, adapterId, timeStamp, signature);
        }
        
        public AdapterControllers.cdvrAdap.RecordingResponse DeleteRecording(string recordingId, int adapterId, long timeStamp, string signature) {
            return base.Channel.DeleteRecording(recordingId, adapterId, timeStamp, signature);
        }
        
        public System.Threading.Tasks.Task<AdapterControllers.cdvrAdap.RecordingResponse> DeleteRecordingAsync(string recordingId, int adapterId, long timeStamp, string signature) {
