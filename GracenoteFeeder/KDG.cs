...
{
    public class KDG : BaseGracenoteFeeder
    {

        #region CONST
        private const string TVPROGRAM_FETCH = "TVPROGRAM_FETCH";
        #endregion
        ...
        public KDG(string sClient, string sUser, int nGroupID, int nParentGroupID = 0, int nUpdaterID = 0)
        {
            groupID = nGroupID;
         ...
         */
        public override void SaveChannel(XmlDocument xmlDoc)
        {
            try
            {
                string channel_id = "";
        ...
        private string GetImageFromGN(XmlNode node, string EPGGuid)
        {
            ...
            try
            {
                ...
                string method = "POST";
                string postData = "<QUERIES>  <AUTH>   <CLIENT>" + client + "</CLIENT><USER>" + user + "</USER></AUTH>" +
                                "<QUERY CMD=\"" + TVPROGRAM_FETCH + "\"><GN_ID>" + EPGGuid + "</GN_ID>" +
                                "<OPTION> <PARAMETER>SELECT_EXTENDED</PARAMETER> <VALUE>IPGCATEGORY_IMAGE</VALUE> </OPTION>" +
                                "<OPTION><PARAMETER>IMAGE_SIZE</PARAMETER><VALUE>XLARGE,LARGE,MEDIUM,300</VALUE></OPTION>" +
                                "</QUERY></QUERIES>";
