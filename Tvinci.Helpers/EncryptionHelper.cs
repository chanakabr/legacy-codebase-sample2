...
namespace Tvinci.Helpers
{
    ...
    {
        #region Constants
        private const string passPhrase = "1948es3#21s";        // can be any string
        private const string saltValue = "s@1#$#tValue";        // can be any string
        ...
        {
            return RijndaelSimple.Encrypt(value,
                                          passPhrase,
                                          saltValue,
                                          hashAlgorithm,
                                          passwordIterations,
        ...
        {
            return RijndaelSimple.Decrypt(value,
                                          passPhrase,
                                          saltValue,
                                          hashAlgorithm,
                                          passwordIterations,
