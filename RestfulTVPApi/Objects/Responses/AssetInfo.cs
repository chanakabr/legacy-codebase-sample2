    ...
    public class AssetInfo
    {
        ...
        public AssetInfo(MediaObj media, bool shouldAddFiles)
        {
            if (media != null)
            {
                ...
                ExtraParams.Add("start_date", Utils.ConvertToUnixTimestamp(media.m_dStartDate).ToString());
                ExtraParams.Add("final_date", Utils.ConvertToUnixTimestamp(media.m_dFinalDate).ToString());
                ExtraParams.Add("external_ids", media.m_ExternalIDs);
            }
        }

        public AssetInfo(Catalog.MediaObj media, Catalog.AssetStatsResult stats, bool shouldAddFiles) :
        ...
        public AssetInfo(Catalog.EPGChannelProgrammeObject epg)
        {
            Id = epg.EPG_ID;
            Type = 0;
            Name = epg.NAME;
        ...
        public AssetInfo(Catalog.EPGChannelProgrammeObject epg, Catalog.AssetStatsResult stats)
            : this(epg)
        {
            if (stats != null)
            {
