...
// Schema file: SearchMedia.xsd
// Creation Date: 23/09/2012 12:58:11
//--------------------------------------------------------------
...
namespace Tvinci.Data.TVMDataLoader.Protocols.SearchMedia
{
	...
	{
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File Add(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File obj)
		{
			base.Add(obj);
			return obj;
		}

		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File Add()
		{
			return Add(new Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File());
		}

		public void Insert(int index, Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File obj)
		{
			base.Insert(index, obj);
		}

		public void Remove(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File obj)
		{
			base.Remove(obj);
		}

		new public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File this[int index]
		{
			get { return (Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File) base[index]; }
	...
	{
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media Add(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media obj)
		{
			base.Add(obj);
			return obj;
		}

		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media Add()
		{
			return Add(new Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media());
		}

		public void Insert(int index, Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media obj)
		{
			base.Insert(index, obj);
		}

		public void Remove(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media obj)
		{
			base.Remove(obj);
		}

		new public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media this[int index]
		{
			get { return (Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media) base[index]; }
			set { base[index] = value; }
		}
	}
	...
	public partial class Media
	{
		...
		[XmlIgnore]
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File this[int index]
		{
			get { return (Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File) FileCollection[index]; }
		}
		...
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File Remove(int index) 
		{ 
            Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File obj = FileCollection[index];
		...
		[XmlElement(Type=typeof(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.File),ElementName="File",IsNullable=false,Form=XmlSchemaForm.Qualified)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
	...
	[XmlRoot(ElementName="SearchMedia",IsNullable=false),Serializable]
	...
	public partial class @params
	{
		...
		[XmlElement(ElementName="PageSize",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="int")]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
	...
	public partial class response
	{
		...
		[XmlIgnore]
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media this[int index]
		{
			get { return (Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media) MediaCollection[index]; }
		}
		...
		public Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media Remove(int index) 
		{ 
            Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media obj = MediaCollection[index];
		...
		[XmlAttribute(AttributeName="TotalNumOfItems",Form=XmlSchemaForm.Unqualified,DataType="long")]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public long __TotalNumOfItems;
		...
		[XmlIgnore]
		public long TotalNumOfItems
		{ 
			get { return __TotalNumOfItems; }
			set { __TotalNumOfItems = value; __TotalNumOfItemsSpecified = true; }
		}

		[XmlElement(Type=typeof(Tvinci.Data.TVMDataLoader.Protocols.SearchMedia.Media),ElementName="Media",IsNullable=false,Form=XmlSchemaForm.Qualified)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
