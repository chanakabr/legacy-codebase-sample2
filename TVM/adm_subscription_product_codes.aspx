<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_subscription_product_codes" Codebehind="adm_subscription_product_codes.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_subscription_product_codes.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_subscription_product_codes.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_subscription_product_codes.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
<body class="admin_body" onload="GetPageTable('' , 0);">
