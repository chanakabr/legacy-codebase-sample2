<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_billing_settings" Codebehind="adm_billing_settings.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_billing_settings.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
