<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_external_recommendation_search_new" Codebehind="adm_external_recommendation_search_new.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        debugger;
	    RS.Execute("adm_external_recommendation_search_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
	    initDuallistObj('adm_external_recommendation_search_new.aspx')
	}
	function create_csv() {
	    RS.Execute("adm_external_recommendation_search_new.aspx", "GetTableCSV", callback_create_csv, errorCallback);
	}
</script>
</head>
