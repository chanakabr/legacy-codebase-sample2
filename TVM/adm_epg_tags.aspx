<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_tags" Codebehind="adm_epg_tags.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_tags.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_epg_tags.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
