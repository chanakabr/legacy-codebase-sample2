<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_ext_tags_translation_new" Codebehind="adm_ext_tags_translation_new.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_ext_tags_translation_new.aspx", "GetPageContent", orderBy , pageNum , callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							...
							<table style="border-collapse:collapse;">
								...
								<tr>
									<td class="adm_main_header"><h4><% GetHeader1(); %></h4></td>
								</tr>
								<tr>
