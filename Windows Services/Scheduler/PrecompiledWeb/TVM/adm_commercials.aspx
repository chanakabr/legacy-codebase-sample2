<%@ page language="C#" autoeventwireup="true" inherits="adm_commercials, App_Web__-8binqh" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_commercials.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_commercials.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
