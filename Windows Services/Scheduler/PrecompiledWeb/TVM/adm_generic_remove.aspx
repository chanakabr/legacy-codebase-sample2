<%@ page language="C#" autoeventwireup="true" inherits="adm_generic_remove, App_Web__-8binqh" %>
                                            ...
                                            <table width=100% cellpadding=0 cellspacing=0>
                                                ...
                                                <tr style="height: 40px;">
                                                    ...
                                                    <td style="width:100%; white-space: nowrap;" nowrap>
                                                        <table  width=100% cellpadding=0 cellspacing=0>
                                                            <tr>
                                                                <td style="white-space: nowrap; width:100%;" nowrap class=adm_right_menu><% GetSubMenu(); %></td>
