<%@ page language="C#" autoeventwireup="true" inherits="adm_videos, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_videos.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_videos.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
