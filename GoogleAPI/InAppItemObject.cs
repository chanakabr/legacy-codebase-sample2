...
namespace Tvinic.GoogleAPI
{
    ...
    [DataContract()]
    public class InAppItemObject : JWTClaim
    {
        ...
        private string _typ = "google/payments/inapp/item/v1";
        ...
        public InAppItemRequestObject request = null;
        ...
        /// </summary>
        /// <remarks></remarks>
        public InAppItemObject()
        { }

        public InAppItemObject(InAppItemRequestObject request)
        {
        ...
        public InAppItemObject(string name50, string description100, string price, string isoCurrency3,
                       string sellerData200, string sellerId, int? expMin60,
                       string optionalAud = "",
                       string optionalTyp = "",
                       int optionalIat = 0)
        {

            if (!string.IsNullOrEmpty(name50) && isNumeric(price,System.Globalization.NumberStyles.Currency) && !string.IsNullOrEmpty(isoCurrency3) && !string.IsNullOrEmpty(sellerId))
            {
                this.request = new InAppItemRequestObject();
                ...
                this.request.currencyCode = isoCurrency3.Length > 3 ? isoCurrency3.Substring(0, 3) : isoCurrency3;
        ...
        /// <param name="optionalIat">This is an optional parameter. Use only to override default iat value (current UTC time in number of seconds from Unix epoch with skew of -60 secs).</param>
        /// <remarks>Google Sites reference: http://sites.google.com/site/inapppaymentsapi/reference </remarks>
        public InAppItemObject(string name50, string description100, string Init_price, string Init_isoCurrency3, string Init_paymentType,
