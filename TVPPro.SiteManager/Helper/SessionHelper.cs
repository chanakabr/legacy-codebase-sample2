...
namespace TVPPro.SiteManager.Helper
{
    ...
    public class SessionHelper
    {
        ...
        public static bool IsValueInSession(string key)
        {
            ...
            try
            {
                if (HttpContext.Current.Session.Get(key) != null)
                {
                    retVal = true;
                }
            }
        ...
        public static bool GetValueFromSession<TValue>(string key, out TValue value)
        {
            ...
            if (HttpContext.Current.Session.Get(key) is TValue)
            {
                value = (TValue)HttpContext.Current.Session.Get(key);
                return true;
            }
        ...
        public static Country IPCountry
        {
            get
            {
                Country oRet = null;
                GetValueFromSession<Country>("IPCountry", out oRet);
                return oRet;
            }
            set
            {
