...
namespace BuzzFeeder.Implementation.Series
{
    public class TvinciSeriesFavoritesBuzzImpl : BaseSeriesBuzzImpl
    {
        ...
        public TvinciSeriesFavoritesBuzzImpl(int nGroupID, string sSeriesTagType, string[] lSeriesMediaTypeId, DateTime dtPeriod, TimeSpan tsInterval, int Weight, List<string> lActions, List<string> lAssetTypes, List<int> lFormulaWeights)
