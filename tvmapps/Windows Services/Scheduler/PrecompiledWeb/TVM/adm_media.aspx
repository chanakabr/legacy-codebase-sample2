<%@ page language="C#" autoeventwireup="true" inherits="adm_media, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_media.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , search_on_off , search_tag_type , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_media.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
													...
													<td>
														<table width="100%">
															<tr>
																...
																<td class="space01">&nbsp;&nbsp;</td>
																<td><% TVinciShared.DBTableWebEditor.GetSearchSelectOptionsExp("Media Type", "search_tag_type", "media_types", "id", "NAME", "ORDER_NUM", "---", "-1", true, "select distinct id from media_types where group_id " + TVinciShared.PageUtils.GetParentsGroupsStr(TVinciShared.LoginManager.GetLoginGroupID())); %></td>
