<%@ page language="C#" autoeventwireup="true" inherits="adm_commercials_files, App_Web__-8binqh" %>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="<% GetBackURL(); %>";'><a href="#" class="btn">Back</a></td>
								</tr>
							</table>
						</td>
					</tr>
