<%@ page language="C#" autoeventwireup="true" inherits="adm_channels_media, App_Web_tl6m4-ya" %>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_channels.aspx?search_save=1";'><a href="#" class="btn">Back</a></td>
								</tr>
							</table>
						</td>
					</tr>
