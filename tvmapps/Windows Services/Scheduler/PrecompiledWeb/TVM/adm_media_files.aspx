<%@ page language="C#" autoeventwireup="true" inherits="adm_media_files, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_media_files.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_media_files.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_media.aspx?search_save=1";'><a href="#" class="btn">Back</a></td>
								</tr>
							</table>
						</td>
					</tr>
