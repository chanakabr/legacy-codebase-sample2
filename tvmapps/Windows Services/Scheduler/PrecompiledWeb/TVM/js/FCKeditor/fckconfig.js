...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','Cut','Copy','PasteText','PasteWord','-','Print'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','FitWindow','-','About']
] ;
