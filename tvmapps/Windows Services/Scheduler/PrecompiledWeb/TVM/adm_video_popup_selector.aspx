<%@ page language="C#" autoeventwireup="true" inherits="adm_video_popup_selector, App_Web_tl6m4-ya" %>
...
<HEAD>
		...
		<script type="text/javascript">
		    function Send()
		    {
		        ...
		        toSend = document.getElementById("ids_place").value;
		        if (toSend.lastIndexOf(";") == toSend.length - 1)
		            toSend = theIDS.substring(0 ,theIDS.length -1); 
		        if (window.opener && window.opener.document.getElementById("<% GetSendID(); %>"))
		        {
		            window.opener.document.getElementById("<% GetSendID(); %>").value = toSend;
        ...
        <div class="wrapper">
            <div id="pic_b">
	            ...
	            <div class="find"><b class="top"><b></b></b>
		            ...
		            <input name='pics_tag_coll' id='pics_tag_coll' name="" type="text" onkeyup='return tagKeyPress("tags" , "pics_tag" , "VALUE" , "adm_table_header_nbg" , "(id in(select distinct tag_id from media_tags where status=1) )" , "pics_tag");'/>
		            </label>
	            ...
	            <!--/picSelected -->
	            <div class="butLine">&nbsp;<a href="javascript:Send();" class="btn4" title="Send selection">Send selection</a><a class="btn4" href="javascript:window.close();" title="Cancel" class="blueLink">Cancel</a></div>
	            <!--/find -->
	            <div class="picRes">
