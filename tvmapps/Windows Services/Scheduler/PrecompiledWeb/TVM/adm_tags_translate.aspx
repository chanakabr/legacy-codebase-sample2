<%@ page language="C#" autoeventwireup="true" inherits="adm_tags_translate, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_tags_translate.aspx", "GetPageContent", orderBy , pageNum , search_tag_type , search_free , search_translate_status , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tags_translate.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
