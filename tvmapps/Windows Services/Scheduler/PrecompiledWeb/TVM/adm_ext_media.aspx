<%@ page language="C#" autoeventwireup="true" inherits="adm_ext_media, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    ...
    {
        //translated_yes_no = GetSafeDocumentIDVal("translated_yes_no");
        ...
        //RS.Execute("adm_ext_media.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , search_on_off , translated_yes_no , callback_page_content, errorCallback);
        RS.Execute("adm_ext_media.aspx", "GetPageContent", orderBy , pageNum , search_tag , search_free , search_on_off , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_ext_media.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
