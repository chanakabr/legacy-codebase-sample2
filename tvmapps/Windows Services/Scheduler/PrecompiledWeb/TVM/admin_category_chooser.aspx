<%@ page language="C#" autoeventwireup="true" inherits="admin_category_chooser, App_Web_tl6m4-ya" %>
...
<head id="Head1" runat="server">
    ...
    function selectTreeItem(flashID, itemType, itemID){
        ...
        {
	        parent.document.getElementById("<% GetElementID(); %>").value = itemID;
	        var elementName = 'TVMItemView_' + '<% GetElementNum(); %>';
	        parent.document.getElementById( elementName ).innerHTML = "(Current : " + itemID + ")";	        
	    }
    }
