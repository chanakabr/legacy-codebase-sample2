<%@ page language="C#" autoeventwireup="true" inherits="adm_wp_rules, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_wp_rules.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_wp_rules.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
