<%@ page language="C#" autoeventwireup="true" inherits="adm_billing_sms, App_Web__-8binqh" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_billing_sms.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_billing_sms.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
