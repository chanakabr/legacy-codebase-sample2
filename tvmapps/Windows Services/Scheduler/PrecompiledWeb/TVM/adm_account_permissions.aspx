<%@ page language="C#" autoeventwireup="true" inherits="adm_account_permissions, App_Web_tl6m4-ya" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_account_permissions.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_account_permissions.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_accounts.aspx";'><a href="#" class="btn">Back</a></td>
								</tr>
							</table>
						</td>
					</tr>
