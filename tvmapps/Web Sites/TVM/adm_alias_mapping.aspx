<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_alias_mapping" Codebehind="adm_alias_mapping.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_alias_mapping.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_alias_mapping.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
