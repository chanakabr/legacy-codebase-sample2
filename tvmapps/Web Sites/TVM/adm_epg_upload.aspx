<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_upload" Codebehind="adm_epg_upload.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_upload.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
                                        ...
                                        <table>
										    ...
										    <tr>
											    <td style=" padding-bottom:10px;">
									                <span style="font-size:13px; font-weight:bold;line-height:28px;">Upload Epg xml file</span><br />
                                            ...
                                            <tr>
											    <td class="style1">
									               <asp:Button ID="ButtonUpload" runat="server" onclick="UploadEpgFile" 
