...
public partial class adm_finance_config_tax_new : System.Web.UI.Page
{
    ...
    {
        string sRet = PageUtils.GetPreHeader() + ": Tax";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sBack = "adm_finance_config_tax.aspx?search_save=1";
        ...
        string sTable = theRecord.GetTableHTML("adm_finance_config_tax_new.aspx?submited=1");
