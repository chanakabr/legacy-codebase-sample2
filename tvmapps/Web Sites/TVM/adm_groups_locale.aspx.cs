...
public partial class adm_groups_locale : System.Web.UI.Page
{
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        DataTableLinkColumn extraLanguagesLinkColumn = new DataTableLinkColumn("adm_groups_locale_extra_languages.aspx", "Extra Languages", "");
        extraLanguagesLinkColumn.AddQueryStringValue("group_locale_id", "field=id");
        theTable.AddLinkColumn(extraLanguagesLinkColumn);
