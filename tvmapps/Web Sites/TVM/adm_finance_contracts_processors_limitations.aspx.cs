...
public partial class adm_finance_contracts_processors_limitations : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Int32 nMenuID = 0;
            m_sMenu = TVinciShared.Menu.GetMainMenu(7, true, ref nMenuID, "adm_finance_contracts_processors.aspx");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ":" + PageUtils.GetTableSingleVal("fr_financial_entities", "NAME", int.Parse(Session["fr_entity_id"].ToString())).ToString() + " Processors payments methods limitations ");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_processors.aspx", LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_processors.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_processors.aspx", LoginManager.PAGE_PERMISION_TYPE.PUBLISH))
        {
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["ContentPage"] = "adm_finance_contracts_processors.aspx";
