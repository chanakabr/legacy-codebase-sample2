<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_subscription_names" Codebehind="adm_subscription_names.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_subscription_names.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_subscription_names.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
