<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_financial_contracts_co" Codebehind="adm_financial_contracts_co.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_financial_contracts_co.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_financial_contracts_co.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
