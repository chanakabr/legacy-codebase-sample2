<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_tags_refferences" Codebehind="adm_epg_tags_refferences.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_tags_refferences.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_epg_tags_refferences.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
