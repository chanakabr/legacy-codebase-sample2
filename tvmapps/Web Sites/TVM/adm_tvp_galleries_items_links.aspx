<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvp_galleries_items_links" Codebehind="adm_tvp_galleries_items_links.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_galleries_items_links.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_galleries_items_links.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td id="back_btn" onclick='window.document.location.href="<% GetBackLink(); %>";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
