...
public partial class adm_finance_contract_tax_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (LoginManager.IsPagePermitted("adm_finance_contracts_tax.aspx") == false)
        ...
        {
            Int32 nMenuID = 0;
            m_sMenu = TVinciShared.Menu.GetMainMenu(7, true, ref nMenuID, "adm_finance_contracts_tax.aspx");
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        if (sOrderBy != "")
        {
            ...
            theTable += " order by q.Start_date";
        theTable.AddHiddenField("ID");
        theTable.AddHiddenField("status");
        theTable.AddOrderByColumn("Name", "q.Name");
        theTable.AddOrderByColumn("Start date", "q.Start_date");
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_tax.aspx", LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_finance_contract_tax_list_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("fr_contract_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_tax.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_finance_contracts_tax.aspx", LoginManager.PAGE_PERMISION_TYPE.PUBLISH))
        {
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["ContentPage"] = "adm_finance_contracts_tax.aspx";
        Session["LastContentPage"] = "adm_finance_contract_tax_list.aspx?search_save=1";
