...
public partial class adm_pre_paid_modules_new : System.Web.UI.Page
{
    ...
    protected DataTable GetPriceCodesDT(TVM.TvinciPricing.mdoule m, string sWSUserName, string sWSPass)
    {
    ...
    protected DataTable GetUsageModulesDT(TVM.TvinciPricing.mdoule m, string sWSUserName, string sWSPass)
    {
    ...
    protected DataTable GetDiscountsDT(TVM.TvinciPricing.mdoule m, string sWSUserName, string sWSPass)
    {
    ...
    protected DataTable GetCouponsDT(TVM.TvinciPricing.mdoule m, string sWSUserName, string sWSPass, ref string sMainLang)
    {
