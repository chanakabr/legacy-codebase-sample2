...
public partial class adm_user_purchases_report : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        TVM.ca_ws.BillingTransactions casResponse = p.GetUserBillingHistory(sWSUserName, sWSPass, user, 0, 1000, TVM.ca_ws.TransactionHistoryOrderBy.CreateDateDesc);
        ...
        {
            casResponse = p.GetUserBillingHistory(sWSUserName, sWSPass, user, 0, transactionsResponse.m_nTransactionsCount, TVM.ca_ws.TransactionHistoryOrderBy.CreateDateDesc);
