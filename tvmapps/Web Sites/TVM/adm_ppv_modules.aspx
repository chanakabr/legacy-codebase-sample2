<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_ppv_modules" Codebehind="adm_ppv_modules.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_ppv_modules.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_ppv_modules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
