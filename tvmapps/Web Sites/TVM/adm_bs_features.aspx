<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_bs_features" Codebehind="adm_bs_features.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_bs_features.aspx", "GetPageContent", orderBy , pageNum , search_status , search_assigned , search_savirity , search_department , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_bs_projects.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
