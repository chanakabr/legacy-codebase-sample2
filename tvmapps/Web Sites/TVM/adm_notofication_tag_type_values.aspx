<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_notofication_tag_type_values" Codebehind="adm_notofication_tag_type_values.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_notofication_tag_type_values.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }   
