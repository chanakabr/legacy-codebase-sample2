<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_discounts" Codebehind="adm_discounts.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_discounts.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_discounts.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
