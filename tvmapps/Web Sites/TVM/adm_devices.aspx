<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_devices" Codebehind="adm_devices.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_devices.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_devices.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
