<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_collection_channels" Codebehind="adm_collection_channels.aspx.cs" %>
...
<body class="admin_body" onload="initDuallistObj('adm_collection_channels.aspx')">
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_collections.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
