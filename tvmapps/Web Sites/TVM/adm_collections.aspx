<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_collections" Codebehind="adm_collections.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_collections.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_collections.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
