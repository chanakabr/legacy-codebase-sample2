<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_price_codes_descriptions" Codebehind="adm_price_codes_descriptions.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_price_codes_descriptions.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_price_codes_descriptions.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
