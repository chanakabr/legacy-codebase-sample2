<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_topic_notification_message" Codebehind="adm_topic_notification_message.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_topic_notification_message.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    ...
    function create_csv() {
        RS.Execute("adm_topic_notification_message.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
							    ...
							    <tr>
								    <td onclick='window.document.location.href="adm_topic_notification.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
                            </table>
						</td>
					</tr>
