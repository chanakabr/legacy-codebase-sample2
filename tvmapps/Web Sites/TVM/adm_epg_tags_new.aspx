<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_tags_new" Codebehind="adm_epg_tags_new.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_tags_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
