<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_channel_defaults" Codebehind="adm_epg_channel_defaults.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_epg_channel_defaults.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
