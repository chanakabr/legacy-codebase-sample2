<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_edit_group_permissions" Codebehind="adm_edit_group_permissions.aspx.cs" %>
...
<script type="text/javascript">
    function editGroup() {
        ...
        var selectedIndex = groupsList.selectedIndex;
        var groupName = groupsList.options[selectedIndex].text;
        submitASPFormWithCheck("adm_edit_group_permissions.aspx?selectedIndex=" + selectedIndex + "&groupName=" + groupName);
    }
</script>

</head>
<body class="admin_body" onload="initDuallistObj('adm_edit_group_permissions.aspx')">
					...
					<tr>
						...
						<td style="width:100%;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td>                                  
                                        <label>Select Group And Confirm To Edit Permissions</label>
                                        <select id="groups" runat="server" />                  
                                    </td>
                                </tr>
                                <tr style="padding-top:30px"><td id="confirm_btn" onclick='editGroup();'><a tabindex="2000" href="#confirm_btn" class="btn"></a></td></tr>                        
                                <tr>
                                    <td>
