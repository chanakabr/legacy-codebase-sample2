<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_epg_channels" Codebehind="adm_epg_channels.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_epg_channels.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_epg_channels.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
