<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_device_management" Codebehind="adm_device_management.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_device_management.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_device_management.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
