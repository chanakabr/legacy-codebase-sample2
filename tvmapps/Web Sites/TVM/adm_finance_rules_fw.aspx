<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_rules_fw" Codebehind="adm_finance_rules_fw.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_finance_rules_fw.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_rules_fw.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
