<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_payment_gateway_payment_method" Codebehind="adm_payment_gateway_payment_method.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_payment_gateway_payment_method.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_payment_gateway_payment_method.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
