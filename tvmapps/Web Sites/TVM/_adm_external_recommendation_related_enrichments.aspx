<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_external_recommendation_related_enrichments" Codebehind="_adm_external_recommendation_related_enrichments.aspx.cs" %>
...
<body class="admin_body" onload="initDuallistObj('adm_external_recommendation_related_enrichments.aspx')">
                        ...
                        <tr>
                            ...
                            <td style="width: 800px;" valign="top" nowrap>
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td onclick='window.document.location.href="adm_external_recommendation_related_new.aspx?search_save=1&group_id=<% GetGroupId(); %>";'><a class="btn_back"></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
