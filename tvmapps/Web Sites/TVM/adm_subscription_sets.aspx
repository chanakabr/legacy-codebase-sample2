<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_subscription_sets" Codebehind="adm_subscription_sets.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_subscription_sets.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_subscription_sets.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
