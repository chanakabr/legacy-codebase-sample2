<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_device_rules" Codebehind="adm_device_rules.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_device_rules.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_device_rules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
