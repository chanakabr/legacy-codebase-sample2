<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_contracts_processors" Codebehind="adm_finance_contracts_processors.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_finance_contracts_processors.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_contracts_processors.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
