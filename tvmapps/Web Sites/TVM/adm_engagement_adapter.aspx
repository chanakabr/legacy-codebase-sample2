<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_engagement_adapter" Codebehind="adm_engagement_adapter.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_engagement_adapter.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_engagement_adapter.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
