<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_comments_filter" Codebehind="adm_comments_filter.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_comments_filter.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_comments_filter.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td>
                                    <a class="btn" href="javascript:OpenCommentsFilterBrowser();">Tester</a>
                                    </td>
                                </tr>
							</table>
						</td>
