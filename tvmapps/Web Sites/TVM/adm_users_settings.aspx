<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" Inherits="adm_users_settings" Codebehind="adm_users_settings.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_users_settings.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
