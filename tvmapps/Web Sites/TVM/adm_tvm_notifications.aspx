<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvm_notifications" Codebehind="adm_tvm_notifications.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_tvm_notifications.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_tvm_notifications.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
