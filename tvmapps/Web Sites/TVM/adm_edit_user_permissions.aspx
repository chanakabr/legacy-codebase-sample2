<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_edit_user_permissions" Codebehind="adm_edit_user_permissions.aspx.cs" %>
...
<script type="text/javascript">
    function editUser() {
        ...
        submitASPFormWithCheck("adm_edit_user_permissions.aspx?selectedIndex=" + selectedIndex + "&userID=" + userID);
    }
</script>

</head>
<body class="admin_body" onload="initDuallistObj('adm_edit_user_permissions.aspx')">
					...
					<tr>
						...
						<td style="width:100%;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>
                                    <td>                                  
                                        <label>Select User And Confirm To Edit Permissions</label>
                                        <select id="users" runat="server" />                  
                                    </td>
                                </tr>
                                <tr style="padding-top:30px"><td id="confirm_btn" onclick='editUser();'><a tabindex="2000" href="#confirm_btn" class="btn"></a></td></tr>
								<tr>
									<td>
