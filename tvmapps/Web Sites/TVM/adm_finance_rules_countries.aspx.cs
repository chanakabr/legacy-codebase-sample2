...
public partial class adm_finance_rules_countries : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select gbt.id as id,gbt.NAME as 'Rule name',gbt.status,lcs.description as 'State' from geo_block_types gbt,lu_content_status lcs where lcs.id=gbt.status and gbt.status<>2 and GEO_RULE_TYPE=2 and ";
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_finance_rules_countries_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("finance_block_rule_id", "field=id");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Countries rules");
    }
}
