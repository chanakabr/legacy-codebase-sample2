...
public partial class adm_drm_adapter : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable.AddActivationField("drm_adapters");
        theTable.SetConnectionKey("MAIN_CONNECTION_STRING");

        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_drm_adapter_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("drm_adapter_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "drm_adapters");
