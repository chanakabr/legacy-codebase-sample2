<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_billing_transactions" Codebehind="adm_billing_transactions.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_billing_transactions.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_billing_transactions.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
