<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_groups" Codebehind="adm_groups.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_groups.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_groups.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
