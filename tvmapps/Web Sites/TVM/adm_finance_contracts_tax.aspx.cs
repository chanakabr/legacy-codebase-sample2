...
public partial class adm_finance_contracts_tax : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Tax Contracts");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += ODBCWrapper.Parameter.NEW_PARAM("t.entity_type", "=", 3);
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_finance_contract_tax_list.aspx", "Contracts", "");
