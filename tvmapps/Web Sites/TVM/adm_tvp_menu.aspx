<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvp_menu" Codebehind="adm_tvp_menu.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_menu.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_menu.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
