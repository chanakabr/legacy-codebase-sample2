<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_media_locales" Codebehind="adm_media_locales.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_media_locales.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_media_locales.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
