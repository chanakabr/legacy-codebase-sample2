<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_suppressed_order" Codebehind="adm_suppressed_order.aspx.cs" %>
...
<meta content="Yuval the king!!" name="Author" />
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_suppressed_order.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
								...
								<tr>
                                    <td style="direction: ltr">
                                        <table>
                                            <tr>
                                                <td>
                                                    <span style="font-size:13px; font-weight:bold;line-height:28px;">List of indexes (comma separated) 
                                                    :&nbsp;
											...
											<tr>
												<td>
													<span style="font-size:11px; font-weight:lighter; line-height:28px; color: #808080;">Example: content_reference_id, series_id &nbsp;</span><br />
												</td>
											</tr>
                                            <tr>
                                                <td>
													<asp:Button ID="btnConfirm" runat="server"
														OnClick="btnConfirm_Click" CssClass="btn_confirm" BorderStyle="None" PostBackUrl="~/adm_suppressed_order.aspx"/>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td>
