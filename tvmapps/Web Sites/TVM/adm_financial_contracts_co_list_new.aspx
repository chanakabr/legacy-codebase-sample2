<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_financial_contracts_co_list_new" Codebehind="adm_financial_contracts_co_list_new.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_financial_contracts_co_list_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
