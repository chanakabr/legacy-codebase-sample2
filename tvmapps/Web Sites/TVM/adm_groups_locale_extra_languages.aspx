<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_groups_locale_extra_languages" Codebehind="adm_groups_locale_extra_languages.aspx.cs" %>
...
<body class="admin_body" onload="initDuallistObj('adm_groups_locale_extra_languages.aspx')">
					...
					<tr>
						...
						<td style="width:100%;" valign=top nowrap>
							<table style="border-collapse:collapse;">
                                ...
                                <tr>                                        
                                    <td onclick='window.document.location.href="adm_groups_locale.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
                                </tr>                                               
							</table>
						</td>
					</tr>
