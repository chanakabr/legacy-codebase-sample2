<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_topic_notification" Codebehind="adm_topic_notification.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_topic_notification.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    ...
    function create_csv() {
        RS.Execute("adm_topic_notification.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
