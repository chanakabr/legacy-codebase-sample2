<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_base_addOn_subscription_sets_new" Codebehind="adm_base_addOn_subscription_sets_new.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_base_addOn_subscription_sets_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
        initDuallistObj('adm_base_addOn_subscription_sets_new.aspx')
    }
</script>
</head>
