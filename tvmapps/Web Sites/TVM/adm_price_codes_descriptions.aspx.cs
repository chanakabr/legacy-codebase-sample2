...
public partial class adm_price_codes_descriptions : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Int32 nMenuID = 0;
            m_sMenu = TVinciShared.Menu.GetMainMenu(14, true, ref nMenuID, "adm_price_codes.aspx");
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select pcd.id as id,pcd.language_code3 as 'Language',pcd.description as 'Description',pcd.status,lcs.description as 'State' from price_code_descriptions pcd,lu_content_status lcs where lcs.id=pcd.status and pcd.status<>2 and ";
        ...
        theTable += " and ";
        theTable += ODBCWrapper.Parameter.NEW_PARAM("pcd.price_code_id", "=", int.Parse(Session["price_code_id"].ToString()));
        if (sOrderBy != "")
        {
            theTable += " order by ";
            theTable += sOrderBy;
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_price_codes_descriptions_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("price_code_desc_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_price_codes.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "price_code_descriptions");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["LastContentPage"] = "adm_price_codes_descriptions.aspx?price_code_id=" + Session["price_code_id"].ToString();
        theTable.Finish();
        theTable = null;
        return sTable;
    }
    ...
    public void GetHeader()
    {
        ...
        selectQuery.Finish();
        selectQuery = null;
        Response.Write(PageUtils.GetPreHeader() + ": Price Code (" + sPC + ") descriptions");
    }
}
