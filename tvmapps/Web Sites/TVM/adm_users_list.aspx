<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_users_list" CodeBehind="adm_users_list.aspx.cs" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function GetPageTable(orderBy, pageNum) {
            ...
            search_exact = GetSafeDocumentIDVal("search_exact");

            search_only_unapproved_comments = GetSafeDocumentIDVal("search_only_unapproved_comments");
            search_only_paid_users = "-1";
            RS.Execute("adm_users_list.aspx", "GetPageContent", orderBy, pageNum, search_free, search_exact,  search_only_paid_users, search_only_unapproved_comments, callback_page_content, errorCallback);
        }
        function create_csv() {
            search_free = GetSafeDocumentIDVal("search_free");
            search_exact = GetSafeDocumentIDVal("search_exact");
            window.open("adm_users_list_excel.aspx?search_free=" + search_free + "&search_exact=" + search_exact, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=550, height=400");
        }
    </script>
</head>
                                                        ...
                                                        <td>
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td><% TVinciShared.DBTableWebEditor.GetSearchFree("Search exact", "search_exact", "ltr"); %></td>
                                                                    <td class="space01">&nbsp;&nbsp;</td>
