<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_domains" Codebehind="adm_domains.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_domains.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_domains.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
