<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_media" Codebehind="adm_media.aspx.cs" %>
													...
													<td>
														<table width="100%">
															<tr>
																...
																<td class="space01">&nbsp;&nbsp;</td>
																<td><% TVinciShared.DBTableWebEditor.GetSearchSelectOptions("Comments", "search_only_unapproved_comments", "lu_only_all", "id", "DESCRIPTION", "ID", "---", "-1", true, ""); %></td>
																<td class="space01">&nbsp;&nbsp;</td>
