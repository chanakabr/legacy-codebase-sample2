<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_quota_modules" Codebehind="adm_quota_modules.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_quota_modules.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_quota_modules.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
