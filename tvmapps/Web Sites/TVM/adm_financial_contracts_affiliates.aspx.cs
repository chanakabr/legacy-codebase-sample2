...
public partial class adm_financial_contracts_affiliates : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": Affiliates Contracts");
    }
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_financial_contracts_affiliates_list.aspx", "Contracts", "");
            linkColumn1.AddQueryStringValue("fr_entity_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_financial_contracts_affiliates_limitations.aspx", "Limitations", "");
            linkColumn1.AddQueryStringValue("fr_entity_id", "field=id");
            theTable.AddLinkColumn(linkColumn1);
        }
    }
