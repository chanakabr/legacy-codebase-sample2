...
public partial class adm_statistics_geo : System.Web.UI.Page
{
        ...
        if (selectQuery.Execute("query", true) != null)
        {
            ...
            for (int i = 0; i < nCount; i++)
            {
                ...
                if (dPer > 0.0)
                {
                    ...
                    sRet += "P" + nDays.ToString() + "[" + nColor.ToString() + "]=new Pie(220,110,0,100," + dAngle0.ToString() + "," + dAngle1.ToString() + ",\"" + System.Drawing.ColorTranslator.ToHtml(System.Drawing.ColorTranslator.FromWin32((255 - nID) * 700)) + "\",\"" + sCountryName + " - " + dPer.ToString() + "%\");\r\n";
                    dAngle0 = dAngle1;
                    nColor++;
                }
            }
