<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_ppv_module_new" Codebehind="adm_ppv_modules_new.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_ppv_modules_new.aspx", "changeItemStatus", json.id, json.kind, json.index, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_ppv_modules_new.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    ...
    function GetPageTable(orderBy, pageNum) {
        ...
        RS.Execute("adm_ppv_modules_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							...
							<table style="border-collapse:collapse;">
                                ...
                                <tr style="padding-top:30px"><td id="confirm_btn" onclick='submitASPFormWithCheck("adm_ppv_modules_new.aspx?submited=1");'><a tabindex="2000" href="#confirm_btn" class="btn"></a></td>
                                <td id="cancel_btn" onclick='window.document.location.href="adm_ppv_modules.aspx?search_save=1";'><a tabindex="2000" href="#cancel_btn" class="btn"></a></td>--%>
                                <%--</tr>--%>
							</table>
						</td>
					</tr>
