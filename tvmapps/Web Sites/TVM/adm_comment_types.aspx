<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_comment_types" Codebehind="adm_comment_types.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_comment_types.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_comment_types.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
