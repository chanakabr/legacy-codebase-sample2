...
public partial class adm_media_statistics : System.Web.UI.Page
{
    ...
    {
        string sName = PageUtils.GetTableSingleVal("media", "name", int.Parse(Session["media_id"].ToString())).ToString();
        Response.Write(PageUtils.GetPreHeader() + ": Media Statistics: " + sName);
    }
    ...
    protected Int32 GetNumberOfWatches(bool bUnique, Int32 nDaysAgo)
    {
        ...
        if (bUnique == true)
            ...
            selectQuery += "*";
        selectQuery += ") as co from watchers_media_actions wma where wma.action_id=1 and ";
        if (nDaysAgo > 0)
        {
    ...
    public void GetMediaMounthViewsCountStatistics()
    {
        ...
        selectQuery1 += "(select distinct DatePart(Dd,wma.create_date) as DD,DatePart(Mm,wma.create_date) as MM,DateDiff(dd,'1/1/2000',wma.create_date) as DY  from watchers_media_actions wma where wma.action_id=1 and wma.create_date>DATEADD(m, -1, getdate()))q1 left join ";
        selectQuery1 += "(select  ISNULL(count(distinct watcher_id),0) as co,DatePart(Dd,wma.create_date) as DD,DatePart(Mm,wma.create_date) as MM,DateDiff(dd,'1/1/2000',wma.create_date) as DY  from watchers_media_actions wma where wma.action_id=1 and wma.create_date>DATEADD(m, -1, getdate()) and ";
        ...
        selectQuery += "(select  ISNULL(count(*),0) as co,DatePart(Dd,wma.create_date) as DD,DatePart(Mm,wma.create_date) as MM,DateDiff(dd,'1/1/2000',wma.create_date) as DY  from watchers_media_actions wma where wma.action_id=1 and wma.create_date>DATEADD(m, -1, getdate()) and ";
        selectQuery += ODBCWrapper.Parameter.NEW_PARAM("wma.media_id", "=", int.Parse(Session["media_id"].ToString()));
    ...
    public void GetMediaDayViewCountStatistics()
    {
        ...
        selectQuery1 += "(select  ISNULL(count(distinct watcher_id),0) as co,DatePart(HH,wma.create_date) as HH,DateDiff(hh,'1/1/2000',wma.create_date) as DY  from watchers_media_actions wma where wma.action_id=1 and wma.create_date>DATEADD(d, -1, getdate()) and ";
        selectQuery1 += ODBCWrapper.Parameter.NEW_PARAM("wma.media_id", "=", int.Parse(Session["media_id"].ToString()));
        ...
        selectQuery += "(select  ISNULL(count(*),0) as co,DatePart(HH,wma.create_date) as HH,DateDiff(hh,'1/1/2000',wma.create_date) as DY  from watchers_media_actions wma where wma.action_id=1 and wma.create_date>DATEADD(d, -1, getdate()) and ";
        selectQuery += ODBCWrapper.Parameter.NEW_PARAM("wma.media_id", "=", int.Parse(Session["media_id"].ToString()));
