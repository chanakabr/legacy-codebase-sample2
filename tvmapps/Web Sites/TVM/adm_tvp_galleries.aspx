<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvp_galleries" Codebehind="adm_tvp_galleries.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_galleries.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_1, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_galleries.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
    <% GetAddList(); %>
