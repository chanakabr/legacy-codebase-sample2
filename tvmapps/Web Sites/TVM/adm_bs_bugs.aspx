<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_bs_bugs" Codebehind="adm_bs_bugs.aspx.cs" %>
													...
													<td>
														<table width="100%">
														    <tr>
																...
																<td class="space01">&nbsp;&nbsp;</td>
																<td><% TVinciShared.DBTableWebEditor.GetSearchSelectOptions("Severity", "search_savirity", "lu_savirity", "id", "DESCRIPTION", "ID", "---", "-1", false, ""); %></td>
																<td class="space01">&nbsp;&nbsp;</td>
