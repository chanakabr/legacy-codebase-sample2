...
public partial class adm_finance_contracts_processors_limitations_new : System.Web.UI.Page
{
    ...
    {
        string sRet = PageUtils.GetPreHeader() + ": Processors payment methods monthly limitations";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sBack = "adm_finance_contracts_processors_limitations.aspx?search_save=1";
        ...
        string sTable = theRecord.GetTableHTML("adm_finance_contracts_processors_limitations_new.aspx?submited=1");
