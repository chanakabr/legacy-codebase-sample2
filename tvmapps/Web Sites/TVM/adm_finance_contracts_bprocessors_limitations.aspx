<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_contracts_bprocessors_limitations" Codebehind="adm_finance_contracts_bprocessors_limitations.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_finance_contracts_bprocessors_limitations.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_contracts_bprocessors_limitations.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
					...
					<tr>
						...
						<td style="width:800px;" valign=top nowrap>
							<table style="border-collapse:collapse;">
								...
								<tr>
								    <td onclick='window.document.location.href="adm_finance_contracts_bprocessors.aspx?search_save=1";'><a href="#" class="btn_back"></a></td>
								</tr>
							</table>
						</td>
					</tr>
