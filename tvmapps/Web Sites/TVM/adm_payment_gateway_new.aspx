<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_payment_gateway_new" Codebehind="adm_payment_gateway_new.aspx.cs" %>
...
<script type="text/javascript">   
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_payment_gateway_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
