...
public partial class adm_epg_pics_templates : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += " left  join lu_pics_epg_ratios lur ";
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_epg_pics_templates_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("epg_pic_size_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "epg_pics_sizes");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": EPG Pics Templates");
    }
}