<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_ext_tags" Codebehind="adm_ext_tags.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_ext_tags.aspx", "GetPageContent", orderBy , pageNum , search_tag_type , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_ext_tags.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
