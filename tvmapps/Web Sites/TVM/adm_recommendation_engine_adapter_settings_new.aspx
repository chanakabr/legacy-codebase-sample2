<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_recommendation_engine_adapter_settings_new" Codebehind="adm_recommendation_engine_adapter_settings_new.aspx.cs" %>
...
<script type="text/javascript">
	function GetPageTable(orderBy, pageNum) {
		RS.Execute("adm_recommendation_engine_adapter_settings_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
	}
	function create_csv() {
		RS.Execute("adm_recommendation_engine_adapter_settings_new.aspx", "GetTableCSV", callback_create_csv, errorCallback);
	}
</script>
</head>
