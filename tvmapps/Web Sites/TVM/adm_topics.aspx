<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_topics" Codebehind="adm_topics.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_topics.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    ...
    function create_csv() {
        RS.Execute("adm_topics.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
