...
public partial class adm_financial_config_co_family_list_new : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            m_sMenu = TVinciShared.Menu.GetMainMenu(2, true, ref nMenuID , "adm_finance_config_co.aspx");
    ...
    {
        string sRet = PageUtils.GetPreHeader() + ": Content owners contract families";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sBack = "adm_financial_config_co_family_list.aspx?search_save=1&fr_parent_entity_id=" + Session["fr_parent_entity_id"].ToString();
        ...
        DataRecordShortIntField dr_et1 = new DataRecordShortIntField(false, 9, 9);
        dr_et1.Initialize("Group", "adm_table_header_nbg", "FormInput", "PARENT_ENTITY_ID", false);
        dr_et1.SetValue(Session["fr_parent_entity_id"].ToString());
        theRecord.AddRecord(dr_et1);


        string sTable = theRecord.GetTableHTML("adm_financial_config_co_family_list_new.aspx?submited=1");
