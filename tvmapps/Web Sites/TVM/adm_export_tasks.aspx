<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_export_tasks" Codebehind="adm_export_tasks.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_export_tasks.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_export_tasks.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
