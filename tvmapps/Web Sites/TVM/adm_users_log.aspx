<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_users_log" Codebehind="adm_users_log.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_users_log.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_users_log.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
