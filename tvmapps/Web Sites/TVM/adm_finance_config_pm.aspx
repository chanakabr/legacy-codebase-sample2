<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_config_pm" Codebehind="adm_finance_config_pm.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy , pageNum)
    {
        ...
        RS.Execute("adm_finance_config_pm.aspx", "GetPageContent", orderBy , pageNum , search_free , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_finance_config_pm.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
