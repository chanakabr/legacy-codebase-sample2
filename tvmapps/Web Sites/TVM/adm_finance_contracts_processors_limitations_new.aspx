<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_contracts_processors_limitations_new" Codebehind="adm_finance_contracts_processors_limitations_new.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_finance_contracts_processors_limitations_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
    }
</script>
</head>
