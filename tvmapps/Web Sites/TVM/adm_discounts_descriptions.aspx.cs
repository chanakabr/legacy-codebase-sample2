...
public partial class adm_discounts_descriptions : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Int32 nMenuID = 0;
            m_sMenu = TVinciShared.Menu.GetMainMenu(14, true, ref nMenuID, "adm_discounts.aspx");
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        theTable += "select dcd.id as id,dcd.language_code3 as 'Language',dcd.description as 'Description',dcd.status,lcs.description as 'State' from discount_code_descriptions dcd,lu_content_status lcs where lcs.id=dcd.status and dcd.status<>2 and ";
        ...
        theTable += " dcd.group_id " + PageUtils.GetFullChildGroupsStr(nCommerceGroupID, "");
        //theTable += ODBCWrapper.Parameter.NEW_PARAM("dcd.group_id", "=", nGroupID);
        theTable += " and ";
        theTable += ODBCWrapper.Parameter.NEW_PARAM("dcd.discount_code_id", "=", int.Parse(Session["discount_code_id"].ToString()));
        if (sOrderBy != "")
        {
            theTable += " order by ";
            theTable += sOrderBy;
        ...
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_discounts_descriptions_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("discount_desc_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage("adm_discounts.aspx", LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "discount_code_descriptions");
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        Session["LastContentPage"] = "adm_discounts_descriptions.aspx?discount_code_id=" + Session["discount_code_id"].ToString();
        theTable.Finish();
        theTable = null;
        return sTable;
    }
    ...
    public void GetHeader()
    {
        ...
        selectQuery.Finish();
        selectQuery = null;
        Response.Write(PageUtils.GetPreHeader() + ": Discount Code (" + sPC + ") descriptions");
    }
}
