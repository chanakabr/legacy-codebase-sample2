<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_finance_contracts_ranges_new" Codebehind="adm_finance_contracts_ranges_new.aspx.cs" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function GetPageTable(orderBy, pageNum) {
            RS.Execute("adm_finance_contracts_ranges_new.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
        }
    </script>
</head>
