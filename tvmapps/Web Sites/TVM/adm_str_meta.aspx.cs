...
public partial class adm_str_meta : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (LoginManager.IsPagePermitted("adm_str_meta.aspx") == false)
            LoginManager.LogoutFromSite("login.html");
        else if (LoginManager.IsActionPermittedOnPage("adm_str_meta.aspx", LoginManager.PAGE_PERMISION_TYPE.EDIT) == false)
            LoginManager.LogoutFromSite("login.html");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ":Media String Meta Names");
    }
    ...
    {
        string sMetaName = "Meta" + nIndex.ToString() + " Name";
        string sMetaFieldName = "META" + nIndex.ToString() + "_STR_NAME";
        string sCBField = "IS_META" + nIndex.ToString() + "_STR_RELATED";
        string sCBOTField = "IS_META" + nIndex.ToString() + "_STR_ON_TABLE";
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        DBRecordWebEditor theRecord = new DBRecordWebEditor("groups", "adm_table_pager", "adm_str_meta.aspx", "", "ID", t, "adm_str_meta.aspx", "media_tag_type_id");
