<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_payment_gateway" Codebehind="adm_payment_gateway.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_payment_gateway.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_payment_gateway.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
