<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_media_finacial_contracts" Codebehind="adm_media_finacial_contracts.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function flashEvents(json) {
        switch (json.eventType) {
            case "move":
                ...
                RS.Execute("adm_media_finacial_contracts.aspx", "changeItemStatus", json.id, json.kindc, callback_changeItemStatus, errorCallback);
                break;
            case "ready":
    ...
    function initDualObj() {
        RS.Execute("adm_media_finacial_contracts.aspx", "initDualObj", callback_init_dobj, errorCallback);
    }
    function initPage() {
