...
public partial class adm_ext_tags_translation_new : System.Web.UI.Page
{
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ":External Tags - Translation (" + PageUtils.GetTableSingleVal("tags", "value", int.Parse(Session["tag_id"].ToString())) + " to " + PageUtils.GetTableSingleVal("lu_languages", "name", int.Parse(Session["lang_id"].ToString())) + " )");
    }

    public void GetHeader1()
    {
        Response.Write("Source Language: " + PageUtils.GetTableSingleVal("tags", "value", int.Parse(Session["tag_id"].ToString())));
    }
    ...
    public string GetPageContent(string sOrderBy, string sPageNum)
    {
        ...
        string sRet = "adm_ext_tags_translate.aspx?search_save=1&lang_id=" + Session["lang_id"].ToString();
