<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_device_limitation_modules_new" Codebehind="adm_device_limitation_modules_new.aspx.cs" %>
        ...
        switch (json.eventType) {
            case "move":
                if (json.callerID == 'DualList') {
                    RS.Execute("adm_device_limitation_modules_new.aspx", "changeItemStatus", json.id, json.kind, json.index, callback_changeItemStatus, errorCallback);
                }
                break;
            case "ready":
                if (json.id == 'DualList') {
