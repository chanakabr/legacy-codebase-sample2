<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_operator" Codebehind="adm_operator.aspx.cs" %>
...
<script type="text/javascript">
    function GetPageTable(orderBy, pageNum) {
        RS.Execute("adm_operator.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv() {
        RS.Execute("adm_operator.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
