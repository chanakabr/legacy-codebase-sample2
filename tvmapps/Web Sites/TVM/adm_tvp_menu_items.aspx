<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvp_menu_items" Codebehind="adm_tvp_menu_items.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvp_menu_items.aspx", "GetPageContent", orderBy, pageNum, callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvp_menu_items.aspx", "GetTableCSV", callback_create_csv, errorCallback);
    }
</script>
</head>
