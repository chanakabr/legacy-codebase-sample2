...
public partial class adm_epg_metas : System.Web.UI.Page
{
    ...
    protected void FillTheTableEditor(ref DBTableWebEditor theTable, string sOrderBy)
    {
        ...
        DataTableLinkColumn linkColumn2 = new DataTableLinkColumn("adm_epg_metas_refferences.aspx", "Refferences", "");
        linkColumn2.AddQueryStringValue("epg_meta_id", "field=id");
        ...
        {
            theTable.AddActivationField("epg_metas_types");
        }

        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.EDIT))
        {
            DataTableLinkColumn linkColumn1 = new DataTableLinkColumn("adm_epg_metas_new.aspx", "Edit", "");
            linkColumn1.AddQueryStringValue("epg_meta_id", "field=id");
        ...
        if (LoginManager.IsActionPermittedOnPage(LoginManager.PAGE_PERMISION_TYPE.REMOVE))
        {
            ...
            linkColumn.AddQueryStringValue("table", "epg_metas_types");
    ...
    {
        Response.Write(PageUtils.GetPreHeader() + ": EPG Metas");
    }
}
