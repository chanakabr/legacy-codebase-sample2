<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_series_reminder_template" Codebehind="adm_series_reminder_template.aspx.cs" %>
...
<head>
    ...
    <script type="text/javascript">
        function GetPageTable(orderBy, pageNum) {
            RS.Execute("adm_series_reminder_template.aspx", "GetPageContent", orderBy, pageNum, callback_page_content_with_editor, errorCallback);
        }
    </script>
</head>
                        ...
                        <tr>
                            ...
                            <td style="width: 800px;" valign="top" nowrap>
                                ...
                                <table style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td id="page_content" width="100%" nowrap="nowrap"></td>
                                    </tr>
                                    <tr>
                                        <td>
