<%@ Page Language="C#" AutoEventWireup="true" Inherits="adm_tvc_meta" Codebehind="adm_tvc_meta.aspx.cs" %>
...
<script type="text/javascript">
    ...
    {
        RS.Execute("adm_tvc_meta.aspx", "GetPageContent", orderBy , pageNum , callback_page_content, errorCallback);
    }
    function create_csv()
    {
        RS.Execute("adm_tvc_meta.aspx", "GetTableCSV" , callback_create_csv, errorCallback);
    }
</script>
</head>
