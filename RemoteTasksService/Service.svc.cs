        ...
        public AddTaskResponse AddTask(AddTaskRequest request)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(actionImplementation))
                    taskHandlerName = ApplicationConfiguration.Current.CeleryRoutingConfiguration.GetHandler(request.task);
                else
                    taskHandlerName = ApplicationConfiguration.Current.CeleryRoutingConfiguration.GetHandler(string.Format("{0}.{1}", request.task, actionImplementation));
