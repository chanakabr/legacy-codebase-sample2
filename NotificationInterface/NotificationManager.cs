...
namespace NotificationInterface
{
    ...
    public class NotificationManager
    {
        ...
        /// <returns></returns>
        public Notification GetNotification(long groupID, NotificationTriggerType triggerType)
        {
            try
            {
        ...
        /// <param name="dr"></param>
        /// <returns></returns>
        private Notification CreateNotificationObject(DataRowView dr)
        {
            ...
            objNotification = new Notification(ID, messageType, triggerType, groupID, messageText, smsMessageText, pullMessageText, title, isActive, status, isBroadcast, createdDate, actions, key);
