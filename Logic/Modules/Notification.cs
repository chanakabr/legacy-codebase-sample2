...
namespace Core.Notification
{
    public class Module
    {
        ...
        public static GetUserFollowsResponse GetUserFollows(int nGroupID, int userId, int pageSize, int pageIndex, OrderDir order, int? partnerListType, bool isFollowTvSeriesRequest = false)
        {
            GetUserFollowsResponse response = null;
            try
            {
                response = FollowManager.Get_UserFollows(nGroupID, userId, pageSize, pageIndex, order, partnerListType, isFollowTvSeriesRequest);
            }
            catch (Exception ex)
            {
