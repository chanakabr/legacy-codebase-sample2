    ...
    public class IndexManager
    {
        ...
        public static bool UpsertMedia(int groupId, int assetId)
        {
            ...
            if (doesGroupUsesTemplates)
            {
                ...
                GetMetasAndTagsForMapping(groupId, doesGroupUsesTemplates, ref metas, ref tags, ref metasToPad, esSerializer, null, catalogGroupCache, false);
            }
            else
            {
                GroupManager groupManager = new GroupManager();                
                ...
                GetMetasAndTagsForMapping(groupId, doesGroupUsesTemplates, ref metas, ref tags, ref metasToPad, esSerializer, group, null, false);
            }
                ...
                if (mediaDictionary != null && mediaDictionary.Count > 0 && mediaDictionary.ContainsKey(assetId))
                {
                    foreach (int languageId in mediaDictionary[assetId].Keys)
                    {
                        ...
                        if (language != null)
                        {
                            ...
                            if (media != null)
                            {
                                PadMediaMetas(metasToPad, media);
        ...
        {
            if (metasToPad != null && metasToPad.Count > 0 && media.m_dMeatsValues != null && media.m_dMeatsValues.Count > 0)
            {
        ...
        {
            if (metasToPad != null && metasToPad.Count > 0 && epg.Metas != null && epg.Metas.Count > 0)
            {
