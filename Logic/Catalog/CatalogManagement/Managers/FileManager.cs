        ...
        public static Status DeleteMediaFile(int groupId, long userId, long id)
        {
            ...
            try
            {
                ...
                if (CatalogDAL.DeleteMediaFile(groupId, userId, id))
                {
                    ...
                    // UpdateIndex
                    bool indexingResult = IndexManager.UpsertMedia(groupId, assetFileResponse.Object.AssetId);
                    if (!indexingResult)
                    {
        ...
        public static GenericResponse<AssetFile> UpdateMediaFile(int groupId, AssetFile assetFileToUpdate, long userId, bool isFromIngest = false, AssetFile currentAssetFile = null)
        {
            ...
            try
            {
                ...
                if (result.Status.Code == (int)eResponseStatus.OK)
                {
                    ...
                    {
                        // UpdateIndex
                        bool indexingResult = IndexManager.UpsertMedia(groupId, assetFileToUpdate.AssetId);
                        if (!indexingResult)
                        {
