...
namespace Core.Notification
{
    ...
    //    public Dictionary<int, List<TagIDValue>> tagValueDict { get; set; }
    ...
    //    }
    //    public NotificationTag(int nMediaID, List<int> dTagValues, Dictionary<int, List<TagIDValue>> dtagValueDict)
    //    {
    //        mediaID = nMediaID;
    //        tagValues = dTagValues;
