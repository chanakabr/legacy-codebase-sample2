    ...
    public class ElisaEmailNotification : EmailNotification
    {
        ...
        private static void SendMail(NotificationMessage message)
        {
            try
            {
                ...
                UserResponseObject userObj = Core.Users.Module.GetUserData(nGroupID, ODBCWrapper.Utils.GetSafeStr(message.UserID), string.Empty);
                ...
                bool bSend = Core.Api.Module.SendMailTemplate(nGroupID, emailRequest);
