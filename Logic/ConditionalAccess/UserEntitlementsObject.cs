...
namespace Core.ConditionalAccess
{
    ...
    public class UserEntitlementsObject
    {
        ...
        internal class BundleEntitlements
        {
            ...
            public Dictionary<string, Utils.UserBundlePurchase> EntitledSubscriptions { get; set; }
            public Dictionary<string, Utils.UserBundlePurchase> EntitledCollections { get; set; }
