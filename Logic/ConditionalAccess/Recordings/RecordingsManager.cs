...
namespace Core.Recordings
{
    public class  RecordingsManager
    {
        ...
        internal GenericResponse<ExternalRecording> AddExternalRecording(int groupId, ExternalRecording recording, DateTime viewableUntilDate, DateTime? protectedUntilDate, long domainId, long userId, DateTime? expiryDate)
        {
            GenericResponse<ExternalRecording> result = new GenericResponse<ExternalRecording>();
            try
            {
                System.Data.DataTable dt = RecordingsDAL.AddExternalRecording(groupId, recording, viewableUntilDate, protectedUntilDate, domainId, userId, expiryDate);
