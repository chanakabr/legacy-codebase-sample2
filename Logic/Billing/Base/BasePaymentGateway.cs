...
namespace Core.Billing
{
    public class BasePaymentGateway
    {
        ...
        private int CreateUnifiedTransaction(ref TransactResult response, APILogic.PaymentGWAdapter.TransactionResponse adapterResponse, eTransactionType transactionType, 
