...
namespace Core.Billing
{
    public class Utils
    {
        ...
        internal static List<long> InsertBillingTransaction(int billingProvider, int paymentGatewayId, string xml, PaymentGatewayTransaction paymentGWTransaction, int billingTransactionStatus, int groupId)
        {
            try
            {
                List<long> result = ApiDAL.Insert_NewBillingTransactions(billingProvider, paymentGatewayId, xml, paymentGWTransaction.ID, billingTransactionStatus, groupId);
