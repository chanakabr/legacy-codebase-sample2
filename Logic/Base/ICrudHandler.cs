...
namespace ApiLogic.Base
{
    ...
    {
        GenericResponse<ICrudHandeledObject> Add(int groupId, ICrudHandeledObject objectToAdd, Dictionary<string, object> extraParams = null);
        GenericResponse<ICrudHandeledObject> Update(int groupId, ICrudHandeledObject objectToUpdate, Dictionary<string, object> extraParams = null);
        Status Delete(int groupId, IdentifierT id, Dictionary<string, object> extraParams = null);
        GenericResponse<ICrudHandeledObject> Get(int groupId, IdentifierT id, Dictionary<string, object> extraParams = null);
