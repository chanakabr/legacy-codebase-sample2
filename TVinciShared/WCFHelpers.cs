...
namespace TVinciShared
{
    public static class WCFHelpers
    {
        ...
        private static AdapterConfiguration GetCurrentConfiguration(string adapterNamespace)
        {
            ...
            AdapterConfiguration defaultConfiguration = ApplicationConfiguration.Current.AdaptersConfiguration.ConfigurationDictionary[TcmObjectKeys.DefaultAdapterConfigurationKey];
