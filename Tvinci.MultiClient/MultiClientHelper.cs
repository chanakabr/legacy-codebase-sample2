...
namespace Tvinci.MultiClient
{
    public  class MultiClientHelper
    {
        ...
        {
            string configPath = ConfigurationManager.AppSettings["Tvinci.MultiClient.Configuration.Path"];
        ...
        public UserContext ActiveUserClient
        {
            get
            {
                ...
                {
                    result = HttpContext.Current.Session["TVP.MultiClient.UserClient"] as UserContext;
                    if (result == null)
                    {
                        ...
                        HttpContext.Current.Session["TVP.MultiClient.UserClient"] = result;
                    }
                }
                else
                {
