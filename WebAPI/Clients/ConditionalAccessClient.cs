    ...
    public class ConditionalAccessClient : BaseClient
    {
        ...
        internal List<KalturaCDNAdapterProfile> GetCDNRAdapters(int groupId)
        {
            ...
            try
            {
                using (KMonitor km = new KMonitor(Events.eEvent.EVENT_WS))
                {
                    response = ConditionalAccess.GetCDNAdapters(group.ConditionalAccessCredentials.Username, group.ConditionalAccessCredentials.Password);
                }
            }
            catch (Exception ex)
            {
        ...
        internal bool DeleteCDNAdapter(int groupId, int adapterId)
        {
            ...
            try
            {
                using (KMonitor km = new KMonitor(Events.eEvent.EVENT_WS))
                {
                    response = ConditionalAccess.DeleteCDNAdapter(group.ConditionalAccessCredentials.Username, group.ConditionalAccessCredentials.Password, adapterId);
                }
            }
            catch (Exception ex)
            {
        ...
        internal KalturaCDNAdapterProfile InsertCDNAdapter(int groupId, KalturaCDNAdapterProfile cdnAdapter)
        {
            ...
            try
            {
                using (KMonitor km = new KMonitor(Events.eEvent.EVENT_WS))
                {
                    response = ConditionalAccess.InsertCDNAdapter(group.ConditionalAccessCredentials.Username, group.ConditionalAccessCredentials.Password, wsAdapter);
                }
            }
            catch (Exception ex)
            {
        ...
        internal KalturaCDNAdapterProfile SetCDNAdapter(int groupId, KalturaCDNAdapterProfile adapter)
        {
            ...
            try
            {
                using (KMonitor km = new KMonitor(Events.eEvent.EVENT_WS))
                {
                    response = ConditionalAccess.SetCDNAdapter(group.ConditionalAccessCredentials.Username, group.ConditionalAccessCredentials.Password, wsAdapter);
                }
            }
            catch (Exception ex)
            {
        ...
        internal KalturaCDNAdapterProfile GenerateCDNSharedSecret(int groupId, int adapterId)
        {
            ...
            try
            {
                using (KMonitor km = new KMonitor(Events.eEvent.EVENT_WS))
                {
                    response = ConditionalAccess.GenerateCDNSharedSecret(group.ConditionalAccessCredentials.Username, group.ConditionalAccessCredentials.Password, adapterId);
                }
            }
            catch (Exception ex)
            {
