...
namespace WebAPI.WebServices
{
    public class ConditionalAccessService : System.Web.Services.WebService, IConditionalAccessService
    {
        ...
        //    if (nGroupID != 0)
        //    {
        //        Int32 nMediaID = Core.ConditionalAccess.Utils.GetMediaIDFeomFileID(nMediaFileID, nGroupID);
            ...
            string sCountryCd2, string sLanguageCode3, string sDeviceName, int assetType, string sOverrideEndDate, string sPreviewModuleID)
        {
            ...
            if (nGroupID != 0)
            {
                return Core.ConditionalAccess.Module.GetCustomDataID(nGroupID, sSiteGUID, dPrice, sCurrencyCode3,
                        assetID, sPPVModuleCode, sCampaignCode, sCouponCode, sPaymentMethod, sUserIP, sCountryCd2, sLanguageCode3, sDeviceName, assetType, sOverrideEndDate, sPreviewModuleID);
            }
            else
            {
                if (nGroupID == 0)
            ...
            string sCOUNTRY_CODE, string sLANGUAGE_CODE, string sDEVICE_NAME, bool isRecording)
        {
            ...
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "GetItemLeftViewLifeCycle", ref objConditionalAccess);
            ...
            string sCountryCd2, string sLanguageCode3, string sDeviceName, string ReceiptData)
        {
            ...
            {
                int nMediaFileID = 0;
                Int32 nMediaID = Core.ConditionalAccess.Utils.GetMediaIDFromFileID(sProductCode, nGroupID, ref nMediaFileID);
        ...
        public string GetGoogleSignature(string sWSUserName, string sWSPassword, int nCustomDataID)
        {
            ...
            if (nGroupID != 0)
            {
                return Core.ConditionalAccess.Utils.GetGoogleSignature(nGroupID, nCustomDataID);
            ...
            string sCountryCd2, string sLanguageCode3, string sDeviceName)
        {
            ...
            if (nGroupID != 0)
            {
                Int32 nMediaID = Core.ConditionalAccess.Utils.GetMediaIDFromFileID(nMediaFileID, nGroupID);
            ...
            int productId, eTransactionType transactionType, string coupon, string userIp, string deviceName, int paymentGatewayId, int paymentMethodId, string adapterData)
        {
            ...
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "Purchase", ref casImpl);
                                        ...
                                        int productId, eTransactionType transactionType, string userIp, string deviceName, bool history)
        {
            ...
            // get partner implementation and group ID
            BaseConditionalAccess casImpl = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "GrantEntitlements", ref casImpl);
            ...
            string externalMessage, int failReason, string signature)
        {
            ...
            // get partner implementation and group ID
            BaseConditionalAccess casImpl = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "UpdatePendingTransaction", ref casImpl);
        ...
        string siteGuid, int productId, int productType)
        {
            ...
            int nGroupID = Core.ConditionalAccess.Utils.GetGroupID(wsUserName, wsPassword, "CheckPendingTransaction", ref conditionalAccess);
        ...
        public bool Renew(string sWSUserName, string sWSPassword, string siteguid, long purchaseId, string billingGuid, long endDate)
        {
            ...
            // get partner implementation and group ID
            BaseConditionalAccess casImpl = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "Renew", ref casImpl);
            ...
            List<ApiObjects.AssetFiles> assetFiles)
        {
            ...
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(username, password, "GetItemPricesWithAssets", ref conditionalAccess);
            if (nGroupID != 0 && conditionalAccess != null)
            {
        ...
        public Recording GetRecordingStatus(string sWSUserName, string sWSPassword, long recordingId)
        {
            ...
            int nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword);
        ...
        public Status SwapSubscription(string sWSUserName, string sWSPassword, string userId, int oldSubscription, int newSubscription, string ip, string udid, bool history)
        {
            ...
            BaseConditionalAccess t = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "SwapSubscription", ref t);
        ...
        public bool GiftCardReminder(string sWSUserName, string sWSPassword, string siteguid, long purchaseId, string billingGuid, long endDate)
        {
            ...
            // get partner implementation and group ID
            BaseConditionalAccess casImpl = null;
            Int32 groupId = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "GiftCardReminder", ref casImpl);
        ...
        public CompensationResponse AddCompensation(string sWSUserName, string sWSPassword, string userId, Compensation compensation)
        {
            ...
            BaseConditionalAccess t = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "AddCompensation", ref t);
            if (nGroupID != 0 && t != null)
            {
        ...
        public Status DeleteCompensation(string sWSUserName, string sWSPassword, long compensationId)
        {
            ...
            BaseConditionalAccess t = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "DeleteCompensation", ref t);
            if (nGroupID != 0 && t != null)
            {
        ...
        public CompensationResponse GetCompensation(string sWSUserName, string sWSPassword, long compensationId)
        {
            ...
            BaseConditionalAccess t = null;
            Int32 nGroupID = Core.ConditionalAccess.Utils.GetGroupID(sWSUserName, sWSPassword, "GetCompensation", ref t);
            if (nGroupID != 0 && t != null)
            {
