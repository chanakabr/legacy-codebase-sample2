...
namespace WebAPI.Controllers
{
    ...
    public class AssetController : ApiController
    {
        ...
        [Route("list"), HttpPost]
        [ApiAuthorize]
        public KalturaAssetInfoWrapper List(KalturaIntegerValue[] media_ids, KalturaFilterPager pager = null, List<KalturaCatalogWithHolder> with = null, string language = null,
            int household_id = 0)
        {
        ...
        [ApiAuthorize]
        public KalturaAssetInfoWrapper Related(int media_id, KalturaFilterPager pager = null, List<KalturaIntegerValue> media_types = null,
