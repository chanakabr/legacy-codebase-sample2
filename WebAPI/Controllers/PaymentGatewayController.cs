...
namespace WebAPI.Controllers
{
    ...
    public class PaymentGatewayController : ApiController
    {
        ...
        [ApiAuthorize]
        public Models.Billing.KalturaPaymentGatewayConfiguration GetConfiguration(string pgAlias, string intent)
        {
            ...
            {
                // call client
                response = ClientsManager.BillingClient().GetPaymentGatewayConfiguration(groupId, pgAlias, intent);
            }
            catch (ClientException ex)
            {
                ErrorUtils.HandleClientException(ex);
