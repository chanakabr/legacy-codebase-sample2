...
namespace WS_ConditionalAccess
{
    ...
    public class module : System.Web.Services.WebService
    {
        ...
        public PlaybackContextResponse GetPlaybackContext(string sWSUserName, string sWSPassword, string userId, string udid, string ip, string assetId, eAssetTypes assetType, 
                                                          List<long> fileIds, StreamerType? streamerType, string mediaProtocol, PlayContextType context, UrlType urlType, string adapterData = null)
        {
            ...
            if (groupId != 0 && t != null)
            {
                ...
                response = t.GetPlaybackContext(userId, assetId, assetType, fileIds, streamerType, mediaProtocol, context, ip, udid, out price, urlType, adapterData);
            }
            else
            {
                if (groupId == 0)
