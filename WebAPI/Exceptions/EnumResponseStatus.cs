...
namespace ApiObjects.Response
{
    public enum eResponseStatus
    {
        ...
        HouseholdAlreadyExists = 1000,
        ExceededLimit = 1001,
        DeviceTypeNotAllowed = 1002,
        DeviceNotInHousehold = 1003,
        MasterEmailAlreadyExists = 1004,
        UserNotInHousehold = 1005,
        HouseholdNotExists = 1006,
        HouseholdUserFailed = 1007,
        HouseholdCreatedWithoutNPVRAccount = 1008,
        HouseholdSuspended = 1009,
        DlmNotExist = 1010,
        WrongPasswordOrUserName = 1011,
        HouseholdAlreadySuspended = 1012,
        HouseholdAlreadyActive = 1013,
        LimitationPeriod = 1014,//
        DeviceAlreadyExists = 1015,
        DeviceExistsInOtherHouseholds = 1016,
        NoUsersInHousehold = 1017,
        UserExistsInOtherHouseholds = 1018,
        DeviceNotExists = 1019,
        UserNotExistsInHousehold = 1020,
        ActionUserNotMaster = 1021,
        ExceededUserLimit = 1022,
        HouseholdNotInitialized = 1023,
        DeviceNotConfirmed = 1024,
        RequestFailed = 1025,
        InvalidUser = 1026,
        UserNotAllowed = 1027,
        DuplicatePin = 1028,
        UserAlreadyInHousehold = 1029,
