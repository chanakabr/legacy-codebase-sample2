...
namespace WebAPI.Exceptions
{
    public class ApiException : HttpResponseException
    {
        ...
        public static ClientExceptionType ASSET_FILE_TYPE_NAME_ALREADY_IN_USE = new ClientExceptionType(eResponseStatus.AssetFileTypeNameAlreadyInUse, "The Asset File Type Name Is Already In Use");
