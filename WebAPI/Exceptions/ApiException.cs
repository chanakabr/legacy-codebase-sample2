...
namespace WebAPI.Exceptions
{
    public class ApiException : HttpResponseException
    {
        ...
        public static ApiExceptionType MULTI_VALUE_NOT_SENT_FOR_META_DATA_TYPE_STRING = new ApiExceptionType(StatusCode.MultiValueWasNotSentForMetaDataTypeString, "multipleValue properyy must have a value when KalturaMetaDataType equals STRING");
