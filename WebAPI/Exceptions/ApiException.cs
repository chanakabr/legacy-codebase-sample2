...
namespace WebAPI.Exceptions
{
    public class ApiException : HttpResponseException
    {
        ...
        public static ClientExceptionType NO_CONFIGURATION_FOUND = new ClientExceptionType(eResponseStatus.NoConfigurationFound, "No Configuration Found", "No configuration was found.");
        ...
        public static ClientExceptionType NO_PAYMENT_GATEWAY_TO_INSERT = new ClientExceptionType(eResponseStatus.NoPaymentGatewayToInsert, "No Payment Gateway To Insert", "No payment gateway to Insert.");
