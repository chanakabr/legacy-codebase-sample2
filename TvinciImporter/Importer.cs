...
namespace TvinciImporter
{
    public class Importer : BaseTask
    {
        ...
        public static BaseTask GetInstance(Int32 nTaskID, Int32 nIntervalInSec, string sParameters)
        {
            return new Importer(nTaskID, nIntervalInSec, sParameters);
        }

        static protected Int32 GetSyncStatus(Int32 nGroupID)
        {
            Int32 nStatus = 0;
            bool bCreate = false;
        ...
        static protected void SetSyncStatus(Int32 nGroupID, Int32 nStatus)
        {
        ...
        protected void UpdateSyncStatus(Int32 nImportID, Int32 nStatus)
        {
