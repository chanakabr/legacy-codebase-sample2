...
RUN sh /src/Core/DllVersioning.Core.sh . && dotnet publish -c Release "./IngestV2.Compaction.Tool/IngestV2.Compaction.Tool.csproj" -o /src/published/IngestV2.Compaction.Tool
...
ENV API_LOG_DIR=/var/log/index-compaction/
...
ENTRYPOINT [ "IngestV2.Compaction.Tool/IngestV2.Compaction.Tool" ]
