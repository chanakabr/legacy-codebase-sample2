...
{            
        ...
        where TExpectedResult : DataTable
    {
        ...
        public delegate void InitializeQueryDelegate(TVPApi.ODBCWrapper.DataSetSelectQuery query);
	...
	//    public delegate void InitializeQueryDelegate(TVPApi.ODBCWrapper.DataSetSelectQuery query, TAdditionalData additionalData);
