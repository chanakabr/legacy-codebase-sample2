    ...
    public class WatchHistoryRequest : BaseRequest, IRequestImp
    {
        ...
        public BaseResponse GetResponse(BaseRequest baseRequest)
        {
            ...
            try
            {
                ...
                // get results
                int totalItems = 0;
                List<WatchHistory> res = Catalog.GetUserWatchHistory(m_nGroupID, m_sSiteGuid, AssetTypes, new List<string>(), new List<int>() { (int)eAssetTypes.NPVR, (int)eAssetTypes.EPG }, FilterStatus, NumOfDays,
