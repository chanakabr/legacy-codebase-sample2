...
namespace Catalog
{
    ...
    public class DoesMediaBelongToChannels : BaseRequest, IRequestImp
    {
        ...
        public BaseResponse GetResponse(BaseRequest oBaseRequest)
        {
            try
            {
                DoesMediaBelongToChannels request = (DoesMediaBelongToChannels)oBaseRequest;
                ...
                if (searcher.GetType().Equals(typeof(LuceneWrapper)))
                {
                    ...
                    List<Channel> allChannels = Utils.GetChannelsFromCache(request.m_nGroupID, request.m_lChannelIDs);
