...
namespace TVPApi
{
    ...
    public class APIAutoCompleteLoader : AutoCompleteLoader
    {
        ...
        protected override Tvinci.Data.TVMDataLoader.Protocols.IProtocol CreateProtocol()
        {
            ...
            protocol.root.request.search_data.channel.media_count = ConfigManager.GetInstance(GroupID, Platform.ToString()).SiteConfiguration.Data.Features.MovieFinder.MaxItems.ToString();
