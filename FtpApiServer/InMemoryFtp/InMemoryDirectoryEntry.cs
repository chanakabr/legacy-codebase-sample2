...
namespace FtpApiServer.InMemoryFtp
{
    ...
    public class InMemoryDirectoryEntry : InMemoryFileSystemEntry, IUnixDirectoryEntry
    {
        ...
        public InMemoryDirectoryEntry(IUnixFileSystem fileSystem, InMemoryDirectoryEntry parent, string name, IDictionary<string, IUnixFileSystemEntry> children) : base(fileSystem, parent, name, _defaultPermissions)
        {
            Children = children;
        }
