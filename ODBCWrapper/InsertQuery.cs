        ...
        protected override bool Execute(string oraStr)
        {
            ...
            using (SqlConnection con = new SqlConnection(sConn))
            {
                try
                {
                    ...
                    using (KMonitor km = new KMonitor(KLogMonitor.Events.eEvent.EVENT_DATABASE, null, null, null, null) { Database = command.Connection.Database, QueryType = Events.eDBQueryType.INSERT })
                    {
